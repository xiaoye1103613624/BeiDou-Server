...
import bossConfig from '@/views/bossConfig/locale/en-US';
import eliteBoss from '@/views/game/eliteBoss/locale/en-US';
...
import monsterInvasion from '@/views/game/monsterInvasion/locale/en-US';
import familyLocale from '@/views/family/locale/en-US';
import townConfig from '@/views/townConfig/locale/en-US';
import catchUpExpConfig from '@/views/catchUpExpConfig/locale/en-US';
...
export default {
  ...
  'menu.game.file': 'File',
  'menu.game.monsterInvasion': 'Monster Invasion',
  'menu.game.townConfig': 'Town Config',
  ...
  'menu.family': 'Family',
  'menu.family.guild': 'Guild',
  'menu.family.family': 'Family Tree',
  'menu.family.alliance': 'Alliance',
  'menu.family.marriage': 'Marriage',
