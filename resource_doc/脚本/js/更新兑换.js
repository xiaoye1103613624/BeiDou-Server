...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {	
			...
			gsjb += "#L1##b兑换新#v3605006##z3605006##r(需要#v3700286# + 1000金币)#l\r\n\r\n";
			//gsjb += "#L11##b兑换新#v3605006##z3605006##r(需要#v4004000#*100+1000金币)#l\r\n";
			gsjb += "#L2##b兑换新#v3605009##z3605009##r(需要#v3700290# + 1000金币)#l\r\n\r\n";
			//gsjb += "#L22##b兑换新#v3605009##z3605009##r(需要#v4004001#*100+1000金币)#l\r\n";
			gsjb += "#L3##b兑换新#v3605011##z3605011##r(需要#v3700292# + 1000金币)#l\r\n\r\n";
			//gsjb += "#L33##b兑换新#v3605011##z3605011##r(需要#v4004002#*100+1000金币)#l\r\n";
			gsjb += "#L4##b兑换新#v3605014##z3605014##r(需要#v3700295# + 1000金币)#l\r\n\r\n";
			//gsjb += "#L44##b兑换新#v3605014##z3605014##r(需要#v4004003#*100+1000金币)#l\r\n";
			gsjb += "#L5##b兑换新#v3605007##z3605007##r(需要#v3700287# + 1000金币)#l\r\n\r\n";
            ...
            if (selection == 1) {
                if (cm.haveItem(3700286) == 0 || cm.getMeso() < 1000) {
                    cm.sendNext("#r你的背包内没有足够的#v3700286#\r\n或者你连1000金币都没有\r\n不能进行兑换！");
                    status = -1;
                } else {
                    zzks = 1;
					cm.sendGetNumber("#r请输入需要兑换的#v3605006#的数量:\r\n#b当前拥有#v3700286#的数量为：#r#c3700286#\r\n", 1, 1, 10000);
                }
            }    
            if (selection == 11) {
                ...
                if (cm.haveItem(3700290) == 0 || cm.getMeso() < 1000) {
                    cm.sendNext("#r你的背包内没有足够的#v3700290#\r\n或者你连1000金币都没有\r\n不能进行兑换！");
                    status = -1;
                } else {
                    zzks = 2;
					cm.sendGetNumber("#r请输入需要兑换的#v3605009#的数量:\r\n#b当前拥有#v3700290#的数量为：#r#c3700290#\r\n", 1, 1, 10000);
                }
            }
                ...
                if (cm.haveItem(3700292) == 0 || cm.getMeso() < 1000) {
                    cm.sendNext("#r你的背包内没有足够的#v3700292#\r\n或者你连1000金币都没有\r\n不能进行兑换！");
                    status = -1;
                } else {
                    zzks = 3;
					cm.sendGetNumber("#r请输入需要兑换的#v3605011#的数量:\r\n#b当前拥有#v3700292#的数量为：#r#c3700292#\r\n", 1, 1, 10000);
                }
            }
                ...
                if (cm.haveItem(3700295) == 0 || cm.getMeso() < 1000) {
                    cm.sendNext("#r你的背包内没有足够的#v3700295#\r\n或者你连1000金币都没有\r\n不能进行兑换！");
                    status = -1;
                } else {
                    zzks = 4;
					cm.sendGetNumber("#r请输入需要兑换的#v3605014#的数量:\r\n#b当前拥有#v3700295#的数量为：#r#c3700295#\r\n", 1, 1, 10000);
                }
            }
                ...
                if (cm.haveItem(3700287) == 0 || cm.getMeso() < 1000) {
                    cm.sendNext("#r你的背包内没有足够的#v3700287#\r\n或者你连1000金币都没有\r\n不能进行兑换！");
                    status = -1;
                } else {
                    zzks = 5;
					cm.sendGetNumber("#r请输入需要兑换的#v3605007#的数量:\r\n#b当前拥有#v3700287#的数量为：#r#c3700287#\r\n", 1, 1, 10000);
                }
            }
			...
			if (zzks == 1) {
                if (cm.haveItem(3700286, selection) && cm.getMeso() >= selection) {
                    cm.gainItem(3700286, -selection);
					cm.gainMeso(-1000*selection);
					cm.gainItem(3605006, selection);
                    cm.sendOk("#b你已成功使用#v3700286#*#r"+selection+"\r\n#b兑换了#v3605006#*#r"+selection+"#b！");
                ...
                if (cm.haveItem(3700290, selection) && cm.getMeso() >= selection) {
                    cm.gainItem(3700290, -selection);
					cm.gainMeso(-1000*selection);
					cm.gainItem(3605009, selection);
                    cm.sendOk("#b你已成功使用#v3700290#*#r"+selection+"\r\n#b兑换了#v3605009#*#r"+selection+"#b！");
                ...
                if (cm.haveItem(3700292, selection) && cm.getMeso() >= selection) {
                    cm.gainItem(3700292, -selection);
					cm.gainMeso(-1000*selection);
					cm.gainItem(3605011, selection);
                    cm.sendOk("#b你已成功使用#v3700292#*#r"+selection+"\r\n#b兑换了#v3605011#*#r"+selection+"#b！");
                ...
                if (cm.haveItem(3700295, selection) && cm.getMeso() >= selection) {
                    cm.gainItem(3700295, -selection);
					cm.gainMeso(-1000*selection);
					cm.gainItem(3605014, selection);
                    cm.sendOk("#b你已成功使用#v3700295#*#r"+selection+"\r\n#b兑换了#v3605014#*#r"+selection+"#b！");
                ...
                if (cm.haveItem(3700287, selection) && cm.getMeso() >= selection) {
                    cm.gainItem(3700287, -selection);
					cm.gainMeso(-1000*selection);
					cm.gainItem(3605007, selection);
                    cm.sendOk("#b你已成功使用#v3700287#*#r"+selection+"\r\n#b兑换了#v3605007#*#r"+selection+"#b！");
                ...
                if (cm.haveItem(3605006, selection*1) && cm.haveItem(3605009, selection*1) && cm.haveItem(3605011, selection*1) && cm.haveItem(3605014, selection*1) && cm.haveItem(3605007, selection*1) && cm.getMeso() >= selection000) {
                    cm.gainItem(3605006, -selection*1);
					cm.gainItem(3605009, -selection*1);
					cm.gainItem(3605011, -selection*1);
					cm.gainItem(3605014, -selection*1);
					cm.gainItem(3605007, -selection*1);
					cm.gainMeso(-1000000*selection);
					cm.gainItem(4251202, selection);
                    cm.sendOk("#b你已成功使用#v3605006##v3605009##v3605011##v3605014##v3605007#*#r"+selection*1+"#b兑换了#v4251202#*#r"+selection+"#b！");
