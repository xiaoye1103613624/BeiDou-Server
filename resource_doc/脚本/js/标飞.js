    ...
    if (mode == -1) {
        ...
        if (status == 0) {
			...
			text +=""+美化1+""+美化2+""+美化2+""+美化2+""+美化2+""+美化2+""+美化2+""+标题dabaims+""+美化2+""+美化2+""+美化2+""+美化2+""+美化2+""+美化2+""+美化3+"#k\r\n\r\n"
					...
					text += " #L1# [进阶 LVL"+第1个代码所需+" < - > "+第1个代码加点+"级 #s"+第1个代码+"#4]#l\r\n\r\n"//3
}
                    if(cm.getPlayer().getSkillLevel(第2个代码)<第2个代码加点){
					text += " #L2# [进阶 LVL"+第2个代码所需+" < - > "+第2个代码加点+"级 #s"+第2个代码+"#3]#l\r\n\r\n"//3
}
                    if(cm.getPlayer().getSkillLevel(第3个代码)<第3个代码加点){
					text += " #L3# [进阶 LVL"+第3个代码所需+" < - > "+第3个代码加点+"级 #s"+第3个代码+"#2]#l\r\n\r\n"//3
}
                    if(cm.getPlayer().getSkillLevel(第4个代码)<第4个代码加点){
					text += " #L4# [进阶 LVL"+第4个代码所需+" < - > "+第4个代码加点+"级 #s"+第4个代码+"#1]#l\r\n\r\n"//3
        } else {
