...
var itemList = Array(
	...
	//兑换 抵用*1需要枫叶*2  编号排序
        ...
        Array(4322952,1,3994742,10000,0)
...
function action(mode, type, selection) {
	...
	if (status == 0) {
		...
		if (兑换的物品 == 0) { //金币
			...
			//cm.laba("钓鱼系统处 兑换了 金币 ：" + 兑换的数量); //新增快捷喇叭
			//cm.youlog("充值东西记录.txt", "钓鱼系统处 兑换了 金币 ：" + 兑换的数量);
		} else if (兑换的物品 == 1) { //点卷
			cm.getPlayer().modifyCSPoints(1, +兑换的数量, true); //点券
			var 使用的物品名称 = cm.getItemName(itemList[兑换的编号][2]);
			var 兑换的物品名称 = cm.getItemName(兑换的物品);
			cm.喇叭(2, "玩家[" + cm.getName() + "] 使用了 " + 使用的物品名称 + "*" + (itemList[兑换的编号][3] * 份数) + " 兑换了 点卷*" + 兑换的数量);
			//cm.laba("钓鱼系统处 兑换了 点卷 ：" + 兑换的数量); //新增快捷喇叭
			//cm.youlog("充值东西记录.txt", "钓鱼系统处 兑换了 点卷 ：" + 兑换的数量);
		} else if (兑换的物品 == 2) { //抵用
			cm.getPlayer().modifyCSPoints(2, +兑换的数量, true); //点券
			var 使用的物品名称 = cm.getItemName(itemList[兑换的编号][2]);
			var 兑换的物品名称 = cm.getItemName(兑换的物品);
			cm.喇叭(2, "玩家[" + cm.getName() + "] 使用了 " + 使用的物品名称 + "*" + (itemList[兑换的编号][3] * 份数) + " 兑换了 抵用卷*" + 兑换的数量);
			//cm.laba("钓鱼系统处 兑换了 抵用卷 ：" + 兑换的数量); //新增快捷喇叭
			//cm.youlog("充值东西记录.txt", "钓鱼系统处 兑换了 抵用卷 ：" + 兑换的数量);
		} else if (兑换的物品 == 3) { //jifen
			cm.setmoneyb(+兑换的数量);
			var 使用的物品名称 = cm.getItemName(itemList[兑换的编号][2]);
			var 兑换的物品名称 = cm.getItemName(兑换的物品);
			cm.喇叭(2, "玩家[" + cm.getName() + "] 使用了 " + 使用的物品名称 + "*" + (itemList[兑换的编号][3] * 份数) + " 兑换了 元宝*" + 兑换的数量);
			//cm.laba("钓鱼系统处 兑换了 充值币 ：" + 兑换的数量); //新增快捷喇叭
			//cm.youlog("充值东西记录.txt", "钓鱼系统处 兑换了 充值币 ：" + 兑换的数量);
		} else if (兑换的物品 == 4) { //豆豆
			cm.getPlayer().gainBeans(+兑换的数量);
			//cm.laba("钓鱼系统处 兑换了 豆豆 ：" + 兑换的数量); //新增快捷喇叭
			//cm.youlog("充值东西记录.txt", "钓鱼系统处 兑换了 豆豆 ：" + 兑换的数量);
		} else if (兑换的物品 == 5) { //hp
			cm.getPlayer().addmaxHP(+兑换的数量);
			//cm.laba("兑换了 HP ：" + 兑换的数量); //新增快捷喇叭
			//cm.youlog("充值东西记录.txt", "钓鱼系统处 兑换了 HP ：" + 兑换的数量);
		} else if (兑换的物品 == 6) { //mp
			cm.getPlayer().addmaxMP(+兑换的数量);
			//cm.laba("兑换了 MP ：" + 兑换的数量); //新增快捷喇叭
			//cm.youlog("充值东西记录.txt", "钓鱼系统处 兑换了 MP ：" + 兑换的数量);
		} else { //物品
			cm.gainItem(兑换的物品, 兑换的数量);
			    // 获取使用的物品名称和兑换的物品名称
			var 使用的物品名称 = cm.getItemName(itemList[兑换的编号][2]);
			var 兑换的物品名称 = cm.getItemName(兑换的物品);
			cm.喇叭(2, "玩家[" + cm.getName() + "] 使用了 " + 使用的物品名称 + "*" + (itemList[兑换的编号][3] * 份数) + " 兑换了 " + 兑换的物品名称 + "*" + 兑换的数量 + "");
		}
