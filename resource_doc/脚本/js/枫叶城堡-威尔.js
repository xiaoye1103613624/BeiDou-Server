...
var fubenm = "挑战威尔"; //副本名称
var bossm = "枫叶城堡"; //BOSS名称+大陆扩充
var bossid = 2400049; //BOSSID
var bossjyxs = "500万"; //BOSS经验显示
var bossjy = 5000000; //BOSS经验
var bossxlxs = "400 亿"; //BOSS血量显示
var bossxl = 40000000000; //BOSS血量
...
var xhwzsl = 10; //消耗物品数量
var zlyqxs = "150 万"; //破攻要求显示
var zlyq = 1500000; //破攻要求
var fubendt = 910028350; //副本地图
...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
            ...
            text += "                 " + 图标1 + "#d 进入要求:#r #v" + cywp + "# * 10 #k张" + "\r\n\r\n";
        ...
        if (msg.length > 0) {
            ...
            return;
                ...
                if (memberCheckPassed) {
					...
					cm.召唤怪物(bossid, bossxl, bossjy, 1, fubendt, 604, 146);
                    cm.给团队每日(fubenm);
