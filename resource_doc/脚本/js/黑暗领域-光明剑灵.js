...
var fubenm = "光明剑灵"; //副本名称
var bossm = "黑暗领域"; //BOSS名称+大陆扩充
var bossid = 8880500; //BOSSID 8880500
var bossjyxs = "500万"; //BOSS经验显示
var bossjy = 5000000; //BOSS经验
var bossxlxs = "50 万亿"; //BOSS血量显示
...
var zlyqxs = "主宰"; //战力要求显示
var zlyq = 21; //仙级要求最高21
var fubendt = 927020000; //副本地图
        ...
        if (msg.length > 0) {
            ...
            return;
                ...
                if (memberCheckPassed) {
                    ...
                    cm.召唤怪物(bossid, bossxl, bossjy, 1, fubendt, 579, 18);
