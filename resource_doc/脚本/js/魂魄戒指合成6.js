...
Array(1115233,1115232,750,750,750,750,750,750),
Array(1115234,1115233,800,800,800,800,800,800)
);
//需求的材料和数量
var req = [
  [4021009, 1999],
...
//需求的金币
var rem = 1000000000;
var yuanbao = 88; // 每次进阶所需的元宝数量
var gailv = 70;//成功率 输入百分之几不要输入百分号只要数字在里面就行了!!
var sels;
var status = -1;
/* 
测试概率代码 
...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        msg += ""+提示+"#k #b进阶说明：#r成功率#r70%，进阶失败材料将会消失\r\n";
        msg += "#g-----------------------------------------------------\r\n";
