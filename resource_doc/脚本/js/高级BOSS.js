...
//------------------------------------------------------------------------
		...
		{
			if(selection == 1){
			   cm.openNpc(9000434,"高级BOSS1");
				}
				
			if(selection == 2){
			   cm.openNpc(9000434,"高级BOSS2");
				}
				
			if(selection == 3){
			   cm.openNpc(9000434,"高级BOSS3");
				}
			if(selection == 21){
			   cm.openNpc(9000434,"高级BOSS21");
				}
				
			if(selection == 22){
			   cm.openNpc(9000434,"高级BOSS22");
				}
				
			if(selection == 23){
			   cm.openNpc(9000434,"高级BOSS23");
				}
			if(selection == 4){
			   cm.openNpc(9000434,"高级BOSS4");
				}
												
			if(selection == 5){
			   cm.openNpc(9000434,"高级BOSS5");
				}
												
			if(selection == 6){
			   cm.openNpc(9000434,"高级BOSS6");
				}
												
			if(selection == 7){
			   cm.openNpc(9000434,"高级BOSS7");
				}
												
			if(selection == 8){
			   cm.openNpc(9000434,"高级BOSS8");
				}
												
			if(selection == 9){
			   cm.openNpc(9000434,"高级BOSS9");
				}
												
			if(selection == 10){
			   cm.openNpc(9000434,"高级BOSS10");
				}
												
			if(selection == 11){
			   cm.openNpc(9000434,"高级BOSS11");
				}
												
			if(selection == 12){
			   cm.openNpc(9000434,"高级BOSS12");
				}
																
			if(selection == 13){
			   cm.openNpc(9000434,"高级BOSS13");
				}
																
			if(selection == 14){
			   cm.openNpc(9000434,"高级BOSS14");
				}
																
			if(selection == 15){
			   cm.openNpc(9000434,"高级BOSS15");
				}
																
			if(selection == 16){
			   cm.openNpc(9000434,"高级BOSS16");
				}
																
			if(selection == 17){
			   cm.openNpc(9000434,"高级BOSS17");
				}
																
			if(selection == 18){
			   cm.openNpc(9000434,"高级BOSS18");
				}
