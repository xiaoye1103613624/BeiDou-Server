...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        //    text += "#d本期的宝物：#r#i" + 商品代码 + "# #z" + 商品代码 + "# * " + 物品数量 + "#k \r\n\r\n";
			text += "#d本期的宝物：#r#i" + 商品代码 + "# #z" + 商品代码 + "##b（全属性 +200、伤害 +10%）\r\n\r\n";
			
            text += ""+红色时钟+" #d剩余数量：#r#e" + 商品还有没 + "/#b30 #d#n份 "+警报灯+"\r\n\r\n";
        ...
        //    text += ""+蓝色时钟+" #d购买须知：每期只能购买#r#e1#n#d次，购买后赠送#r#e" + 价格是多少 + "#d#n 累计\r\n\r\n";
			var 已购次数 = cm.getPlayer().getOneTimeLogcs(冠名);
			text += ""+蓝色时钟+" #d购买须知：本期每人最多购买 #r#e" + 已购次数 + "#d/#b3#n#d 次.\r\n\r\n";
		...
		//	if(cm.getChar().isGM()){
            ...
            if (selection == 1) {
                if (商品还有没 <= 0) { 
                    ...
                    cm.dispose();
                } else if (cm.getPlayer().getOneTimeLogcs(冠名) >= 3) { 
                    cm.sendOkS("本期宝物你已经抢过三次了，等待下期活动吧！.", 2);
                    cm.dispose();
                    ...
                    cm.getPlayer().gainOneTimeLogcs(冠名, 1);      // 每次累加 1
                ...
                //    cm.gainItem(商品代码, 物品数量);
					cm.gainItem(5680236, 1); //宠物道具生效套装属性
					cm.gainItem(商品代码,0,0,200,200,200,200,0,0,200,200,0,0,0,0,0,0);//宠物项圈
