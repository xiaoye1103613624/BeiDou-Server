...
var 列表 = [
    {
        ...
        匹配: [
            {
                消耗道具: 2022693,
                适应职业群: [230, 232],//100~132 之间都是战士代码范围
                技能: [//前置等级表示突破时要求的技能等级必须达到才可以突破
					{ 代码: 2001002, 前置等级: 20, 突破概率: 100 },//魔法盾
					{ 代码: 2001003, 前置等级: 20, 突破概率: 100 },//魔法铠甲
                    { 代码: 2001005, 前置等级: 20, 突破概率: 100 },//魔法双击
					//以上是一转
					{ 代码: 2301001, 前置等级: 20, 突破概率: 80 },//快速移动 距离220
					{ 代码: 2301002, 前置等级: 30, 突破概率: 80 },//群体治愈
					{ 代码: 2301004, 前置等级: 20, 突破概率: 80 },//祝福
					{ 代码: 2301005, 前置等级: 30, 突破概率: 80 },//圣箭术
					//以上是二转
					{ 代码: 2311003, 前置等级: 30, 突破概率: 60 },//神圣祈祷
					{ 代码: 2311004, 前置等级: 30, 突破概率: 60 },//圣光
					//以上是三转
					{ 代码: 2321007, 前置等级: 30, 突破概率: 40 },//光芒飞箭
					{ 代码: 2321006, 前置等级: 30, 突破概率: 40 },//复活术
					{ 代码: 2321003, 前置等级: 30, 突破概率: 40 },//强化圣龙
					//以上是四转
                ]
            },
    ...
    },
    {
        ...
        匹配: [
            {
                消耗道具: 2022693,
                适应职业群: [210, 212],//100~132 之间都是战士代码范围
                技能: [//前置等级表示突破时要求的技能等级必须达到才可以突破
					{ 代码: 2001002, 前置等级: 20, 突破概率: 100 },//魔法盾
					{ 代码: 2001003, 前置等级: 20, 突破概率: 100 },//魔法铠甲
                    { 代码: 2001005, 前置等级: 20, 突破概率: 100 },//魔法双击
					//以上是一转
				    { 代码: 2101001, 前置等级: 20, 突破概率: 80 },//精神力
					{ 代码: 2101002, 前置等级: 20, 突破概率: 80 },//快速移动 距离220
					{ 代码: 2101004, 前置等级: 30, 突破概率: 80 },//火焰箭
					//以上是二转
					{ 代码: 2110001, 前置等级: 30, 突破概率: 60 },//魔力激化
					{ 代码: 2111002, 前置等级: 30, 突破概率: 60 },//末日烈焰
				    { 代码: 2111005, 前置等级: 30, 突破概率: 60 },//魔法狂暴
					{ 代码: 2111006, 前置等级: 30, 突破概率: 60 },//火毒合计
					//以上是三转
				    { 代码: 2121005, 前置等级: 30, 突破概率: 40 },//冰魄魔兽
				    { 代码: 2121003, 前置等级: 30, 突破概率: 40 },//火凤球
				    { 代码: 2121006, 前置等级: 30, 突破概率: 40 },//连环爆破
					//以上是四转
                ]
            },
    ...
    },
    {
        ...
        匹配: [
            {
                消耗道具: 2022693,
                适应职业群: [220, 222],//100~132 之间都是战士代码范围
                技能: [//前置等级表示突破时要求的技能等级必须达到才可以突破
					{ 代码: 2001002, 前置等级: 20, 突破概率: 100 },//魔法盾
					{ 代码: 2001003, 前置等级: 20, 突破概率: 100 },//魔法铠甲
                    { 代码: 2001005, 前置等级: 20, 突破概率: 100 },//魔法双击
					//以上是一转
				    { 代码: 2201001, 前置等级: 20, 突破概率: 80 },//精神力
					{ 代码: 2201002, 前置等级: 20, 突破概率: 80 },//快速移动
					{ 代码: 2201004, 前置等级: 30, 突破概率: 80 },//冰冻术
					//以上是二转
					{ 代码: 2210001, 前置等级: 30, 突破概率: 60 },//魔力激化
				    { 代码: 2211002, 前置等级: 30, 突破概率: 60 },//冰咆哮
					{ 代码: 2211005, 前置等级: 20, 突破概率: 60 },//魔法狂暴
					{ 代码: 2211006, 前置等级: 30, 突破概率: 60 },//冰雷合击
					//以上是三转
					{ 代码: 2221005, 前置等级: 30, 突破概率: 40 },//火魔兽
					{ 代码: 2221003, 前置等级: 30, 突破概率: 40 },//冰凤球
					{ 代码: 2221006, 前置等级: 30, 突破概率: 40 },//连环闪电
                ]
            },
    ...
    if (status == 0) {
        ...
        if (mylv >= maxLv) {
            ...
            if (技能突破概率 >= Math.floor(Math.random() * 100) + 1) {
				...
				cm.喇叭(2,"[技能突破] 玩家:<"+cm.getName()+">魔法师系列[技能]突破成功,当前达到："+cm.getPlayer().getSkillLevel(myskill.技能[sl2].代码)+"级,大家恭喜吧！！！");
            } else {
                //cm.teachSkill(myskill.技能[sl2].代码, mylv - 1, mylv - 1);
                cm.getPlayer().dropMessage(1, "很遗憾，技能突破失败！");
				cm.喇叭(3,"[技能突破] 玩家:<"+cm.getName()+">战士系列[技能]突破失败,好惨啊！！！");
            }
            cm.dispose();
        }
    }
