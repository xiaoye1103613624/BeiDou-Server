...
var fubenm = "神者塞伦·圣"; //副本名称
var bossm = "圣地庭院"; //BOSS名称+大陆扩充
var bossid = 8880612; //BOSSID
var bossjyxs = "500万"; //BOSS经验显示
var bossjy = 5000000; //BOSS经验
var bossxlxs = "250000 亿"; //BOSS血量显示
var bossxl = 25000000000000; //BOSS血量
...
var xhwzsl = 20; //消耗物品数量
var zlyqxs = "5000 万"; //破攻要求显示
var zlyq = 50000000; //破攻要求
var fubendt = 300040012; //副本地图 300040012 927000100
var FBSJ = 3600; //限制时间 秒
var FBSJXS = 60; //显示时间分钟
var inmeso = 1; //入场金币
...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
			...
			text += "                 " + 图标1 + "#d BOSS血量:#r " + bossxl / 1000000000000 + " 万亿 \r\n";
        ...
        if (msg.length > 0) {
            ...
            return;
                ...
                if (memberCheckPassed) {
                    ...
                    cm.召唤怪物(bossid, bossxl, bossjy, 1, fubendt, -22, 329);
