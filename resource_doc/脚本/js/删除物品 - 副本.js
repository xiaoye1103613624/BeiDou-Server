...
var 删除系统 = "#fEffect/CharacterEff1.img/QQ1408745/1/13#";
...
function action(mode, type, selection) {
	...
	if (status <= 0) {
		...
		selStr += "#r#e图标删除区\r\n#n#k(选择需删除物品所在#r[物品栏]#k,再点击需删除的#r物品图标#k)\r\n";
				
		selStr += "#L1#"+kx+""+装备2+"#l #L2#"+kx+""+消耗2+"#l #L3#"+kx+""+设置2+"#l #L4#"+kx+""+其他2+"#l #L5#"+kx+""+特殊2+"#l\r\n\r\n"+群粉心+"";
		
		selStr += "#r#e名字删除区\r\n#n#k(选择需删除物品所在#r[物品栏]#k,再点击需删除的#r物品名字#k)\r\n";
		selStr += "#L11#"+kx+""+装备2+"#l #L12#"+kx+""+消耗2+"#l #L13#"+kx+""+设置2+"#l #L14#"+kx+""+其他2+"#l #L15#"+kx+""+特殊2+"#l\r\n\r\n"+群粉心+"";
		
		selStr += "#r#e书写删除区\r\n#n#k(输入需删除物品所在#r[物品栏]#k,再输入需删除的#r所在格子#k)\r\n";
		selStr += "#L20#"+kx+"#r【点击后输入位置删除】#l#k\r\n\r\n"+群粉心+"";	
		
		selStr += "#r#e批量删除区\r\n#n#k(选择需删除#r[物品栏]#k,批量删除此物品栏#r第24格后所有物品#k)\r\n";
