...
var 扩充 = { 类型: "积分", 价格: 30000, 扩充Log: "云林天宫", 上限: 1 }; //世界树扩充 改了影响到BOSS门口NPC，要同步
...
//	{ 代码: 1352235, 积分: 100000 }, //刷积分备用
	
]

var 商城 = [
	{ 代码: 4310060, 价格: 10000, 数量: 1, 类型: "积分" },
    { 代码: 4310060, 价格: 100000, 数量: 10, 类型: "积分" },
...
function 判断代价(类型) {
	switch (类型) {
		...
		case "元宝": ret = cm.getChar().getmoneyb(); break;
...
function 呈现代价(类型, 数量) {
	...
	switch (类型) {
		...
		case "元宝": text += (数量 != 0 && 数量 != null ? "使用:#r" + 数量 + " 元宝#d" : ""); break;
