...
var fubenm = "女神BOSS"; //副本名称
var bossm = "桃乐丝"; //BOSS名称············
var bossid = 9309207; //BOSSID·············
var bossxlxs = "100亿"; //BOSS血量显示····················
var bossxl = 10000000000; //BOSS血量······················
var zhuansheng = 5; //转生次数·············
var fubendt = 910150100; //副本地图
var fubenzb1 = 412; //副本坐标
var fubenzb2 = -204; //副本坐标
var bossjyxs = "1亿"; //BOSS经验显示
var bossjy = 100000000; //BOSS经验
...
var inmesoxs = "1亿"; //入场金币显示
var inmeso = 100000000; //入场金币
var xhwzid = 3994742; //消耗物品
var xhwzsl = 999; //消耗物品数量
...
function action(mode, type, selection) {
    if (mode == -1) {
		...
		text += "\t#k转生要求: #r" + zhuansheng + " #k次；您当前转生次数: #r"+cm.getPlayer().getOneTimeLogcs("转生")+" #k次\r\n\r\n"
        ...
        cm.sendSimple(text);
            ...
            return;
              ...
              cm.dispose();
              return;
			} else if (cm.getPlayer().getOneTimeLogcs("转生") < zhuansheng){
				cm.sendOk("您的转生次数太低了，别去送死好吧");
				cm.dispose();
              return;
