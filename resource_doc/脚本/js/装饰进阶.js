    ...
    if (mode == -1) {
        ...
        if (status == 0) {
			...
			text += "#r" + 美化1 + "" + 美化2 + "" + 美化2 + "" + 美化2 + "" + 美化2 + "" + 美化2 + "" + 美化2 + "" + 美化2 + "「装备系统」#n" + 美化2 + "" + 美化2 + "" + 美化2 + "" + 美化2 + "" + 美化2 + "" + 美化2 + "" + 美化2 + "" + 美化2 + "" + 美化3 + "#k#k\r\n\r\n";
			 text += " #L1##d" + 爱心7 + "T4武器合成#l    ";
			 text += " \t#L2##d" + 爱心7 + "T3武器合成#l\r\n\r\n";
			 text += " #L3##d" + 爱心7 + "T2武器合成#l    ";
			 text += " \t#L4##d" + 爱心7 + "T1武器合成#l\r\n\r\n";
			 text += " #L5##d" + 爱心7 + "T0武器合成#l    ";
			 text += " \t#L6##d" + 爱心7 + "神器武器合成#l\r\n\r\n";
			 /*text += " #L6##d" + 爱心7 + "T1装备合成#l    ";
			 text += " \t#L66##d" + 爱心7 + "T1武器合成#l\r\n\r\n";
			 text += " #L7##d" + 爱心7 + "T0装备合成#l    ";
			 text += " \t#L77##d" + 爱心7 + "T0武器合成#l\r\n\r\n";
			 text += " #L8##d" + 爱心7 + "神器装备合成#l    ";
			 text += " #L88##d" + 爱心7 + "神器武器合成#l\r\n\r\n";*/
			...
			cm.dispose();
            cm.openNpc(9000438,"合成T4武器");
        } else if (selection == 2) {
			cm.dispose();
            cm.openNpc(9000438, "合成T3武器"); 			
		} else if (selection == 3) {
			cm.dispose();
            cm.openNpc(9000438, "合成T2武器");
		} else if (selection == 4) {
			cm.dispose();
            cm.openNpc(9000438, "合成T1武器");
		} else if (selection == 5) {
			cm.dispose();
            cm.openNpc(9000438, "合成T0武器");
		} else if (selection == 6) {
			cm.dispose();
            cm.openNpc(9000438, "合成神器武器");
		} else if (selection == 7) {
			cm.dispose();
            cm.openNpc(9000438, "10级武器防具制作");
		} else if (selection == 8) {
			cm.dispose();
            cm.openNpc(9000438, "10级武器防具制作");
			}  
