...
var item分解池 = new Array(1303000,1303002,1303003,1303004,1303005,1303006,1303007);
var item分解比例 = new Array(1000,2000,3000,4000,5000,6000,7000);
				...
				while (itemList.hasNext()) {
					...
					for(var i = 0; i<item分解池.length; i++) {
					    	if (item.getItemId() == item分解池[i]) {
								text += "#v" + item.getItemId() + "##z"+item.getItemId()+"# x 可以回收点券"+ item分解比例[i] +"\r\n";
