...
Array(1115229,1115228,570,570,570,570,570,570),
Array(1115230,1115229,600,600,600,600,600,600)
);
//需求的材料和数量
var req = [
  [4021009, 999],
...
//需求的金币
var rem = 900000000;
var yuanbao = 50; // 每次进阶所需的元宝数量
var gailv = 60;//成功率 输入百分之几不要输入百分号只要数字在里面就行了!!
var sels;
var status = -1;
/* 
测试概率代码 
...
function action(mode, type, selection) {
    ...
    if (status == 0) {
		...
		msg += "\r\n"+提示+"#k #b金币消耗：#r"+rem+" #b金币\r\n";
		msg += ""+提示+"#k #b元宝消耗：#r"+yuanbao+" #b元宝\r\n";
		msg += "#g-----------------------------------------------------\r\n";
		msg += ""+提示+"#k #b当前拥有：#r"+cm.getMeso()+" #b金币\r\n";
		msg += ""+提示+"#k #b当前拥有：#r" + cm.getmoneyb() + " #b元宝\r\n";
        msg += ""+提示+"#k #b进阶说明：#r成功率#r60%，进阶失败材料将会消失\r\n";
        msg += "#g-----------------------------------------------------\r\n";
       ...
       cm.sendSimple("\t\t\t\t#r#e魂魄戒指进阶中心#d#n\r\n" + msg + "");
		...
		if (cm.getmoneyb() < yuanbao) {
            cm.sendNext("#b身上没有#r" + yuanbao + "元宝");
            cm.dispose();
            return;
        }
