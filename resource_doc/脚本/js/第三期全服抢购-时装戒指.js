...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        //    text += "#d本期的宝物：#r#i" + 商品代码 + "# #z" + 商品代码 + "# * " + 物品数量 + "#k \r\n\r\n";
			text += "#d本期的宝物：#r#i" + 商品代码 + "# #z" + 商品代码 + "##b全属性+200#r\r\n\t\t\t#i" + 商品代码1 + "# #z" + 商品代码1 + "##b全属性+200 #k \r\n";
			
            text += ""+红色时钟+" #d剩余数量：#r#e" + 商品还有没 + "/#b10 #d#n份 "+警报灯+"\r\n\r\n";
		...
		//	if(cm.getChar().isGM()){
            ...
            if (selection == 1) {
				...
				//	cm.gainItem(商品代码1, 物品数量);
					cm.gainItem(商品代码,0,0,200,200,200,200,0,0,200,200,0,0,0,0,0,0);//时装戒指
					cm.gainItem(商品代码1,0,0,200,200,200,200,0,0,200,200,0,0,0,0,0,0);//时装戒指
                    cm.sendOkS("恭喜您，抢购成功 获得#i" + 商品代码 + "# #i" + 商品代码1 + "# ", 2);
