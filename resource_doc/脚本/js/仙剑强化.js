...
[1112576,3994754,1,2590006,1,2048722,1], //首饰
[1112575,3994753,1,2590006,1,2048722,1],
[1112543,3994754,1,2590006,1,2048722,1],
[1112542,3994753,1,2590006,1,2048722,1],


]
var 成功率增益物品ID = 3605006; // 增加成功率的物品ID
var 每次物品增加的成功率 = 5; // 增加成功率的物品ID
var 每次消耗 = 200; // 增加成功率的物品ID
var 部位 = 0;
var 系数 = 1;
var 强化增加属性 =["四维","攻魔"];
var 强化上线 = 100;
...
455, 460, 465, 470, 475, 480, 485, 490, 495, 500];   //总数25250
...
455000, 460000, 465000, 470000, 475000, 480000, 485000, 490000, 495000, 500000]; //总数25250000
...
355000, 360000, 365000, 370000, 375000, 380000, 385000, 390000, 395000, 400000,  
405000, 410000, 415000, 420000, 425000, 430000, 435000, 440000, 445000, 450000,  
455000, 460000, 465000, 470000, 475000, 480000, 485000, 490000, 495000, 500000]; //总数25 250 000
...
function action(mode, type, selection) {
    ...
    if (status == 0) {
			...
			text += "" + 感叹号 + "#d每次强化成功后#r四维+5#d、#r双攻+5#d递增.满阶总属性+25250\r\n"
