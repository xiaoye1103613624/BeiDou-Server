...
Array(80,1142085,40),
Array(90,1142085,45),
Array(100,1142085,50),
Array(110,1142085,55),
Array(120,1142085,60),
Array(130,1142085,70),
Array(140,1142085,85),
Array(150,1142085,110)
)
var s
function start() {
   status = -1;
    ...
    if (status == 0) {
		...
		var text = "\r\n   " + 心 + " " + 心 + "  " + 心 + "   #r#e < 开心冒险岛 > #k#n " + 心 + "  " + 心 + "  " + 心 + " \r\n\r\n";
			...
			for(var i=0;i<items.length;i++){
				if(dj > items[i]){
					var c = cm.getBossRankCount("主线任务a"+items[i]);
					if(c <1 && ss){
		...
		cm.setBossRankCount("主线任务a"+items[s]);
