...
function action(mode, type, selection) {
    if (mode == -1) {
		...
		case 13:
			...
			case 111:   
			 var text = "";
				text += "\t             #v2616300##r5转技能介绍#v2616300#\r\n";
				//text += "\t#b拥有职业必须完成对应要求才能学习#v2616300#\r\n\r\n";
				text += "  #k英雄技能 #s11101004##l  #k英雄技能 #s11120000##l\r\n";
				text += "#k———————————————————————————\r\n";
				text += "  #k#k圣骑技能 #s15111007##l  #k黑骑技能 #s14001002##l\r\n";
				text += "#k———————————————————————————\r\n";
			    //text += "#k———————————————————————————\r\n";
				text += "  #k火毒技能 #s12001003##l  #k冰雷技能 #s12101006##l\r\n";
				text += "#k———————————————————————————\r\n";
				text += "  #k#k主教技能 #s12101004##l  #k主教技能 #s12111006##l\r\n";
				text += "#k———————————————————————————\r\n";
				//text += "#k———————————————————————————\r\n";
				text += "  #k神射技能 #s13101002##l  #k箭神技能 #s13111002##l\r\n";
				text += "#k———————————————————————————\r\n";
				//text += "#k———————————————————————————\r\n";
				text += "  #k隐士技能 #s14121006##l  #k隐士技能 #s14111002##l\r\n";
				text += "#k———————————————————————————\r\n";
				text += "  #k#k侠盗技能 #s11001003##l  #k侠盗技能 #s14121002##l\r\n";
				text += "#k———————————————————————————\r\n";
				//text += "#k———————————————————————————\r\n";
				text += "  #k冲锋技能 #s15111003##l  #k船长技能 #s15001002##l\r\n";
				text += "#k———————————————————————————\r\n";
				text += "  #k战神技能 #s11121001##l  #k战神技能 #s11001002##l\r\n";
				text += "#k———————————————————————————\r\n";
