...
var hair_Colo_new1;
	function action(mode, type, selection) {
		...
		if (status == 0) {
			...
			text += "#d#e---------↓↓↓超级明星美发区域↓↓↓---------#k#n\r\n\r\n"
			//text += "这里为你准备了最新 发型/脸型,不要挑花眼哦!\r\n";
			text += "#L0#使用: #i5150040##b#t5150040##k随机换发型#l\r\n\r\n\r\n";
			text += "\t以下发型需要消耗:#v" + 超级明星美发卡 + "##b#z" + 超级明星美发卡 + "##k\r\n";
			//text += "#e#r- 发型区域#n#k\r\n";
			text += "\t#L1##r第一版（男） x130 款#l";
			text += "\t#L2##r第二版（男） x130 款#l#k\r\n\r\n";
			text += "\t#L3##r第三版（女） x130 款#l";
			text += "\t#L4##r第四版（女） x130 款#l#k\r\n\r\n";
			text += "\t#L5##r第五版（男） x130 款#l#k\r\n\r\n";
			/*text += "#e#r- 脸型区域#n#k\r\n";
			text += "#L9##k指定脸型第一版(男女通用) x130 款#rNEW#l#k\r\n";
			text += "#L10#指定脸型第二版(男女通用) x130 款#rNEW#l#k\r\n\r\n";
			text += "#e#r- 皮肤区域#n#k\r\n";
