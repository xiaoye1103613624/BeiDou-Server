...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {	
			...
			text += "\t\t\t\t#b#e本职业转生消耗#n#b\r\n"
			text += "\t#i4021009##z4021009# #r*20 #b个 #k+#b #i4011007##z4011007# #r*20 #b个\r\n"
			text += "\t#b#i3605009##z3605009# #r*10 #b个 #k+#b 金币消耗 #r*5 #b亿\r\n"
			text += "\t\t\t\t#b#e本职业转生奖励#n#b\r\n"
			...
			text += "\t\t\t\t#r#e全职业转生消耗#n#b\r\n"
			text += "\t#i4021009##z4021009# #r*20#b个 #k+#b #i4011007##z4011007# #r*20#b个\r\n"
			text += "\t#b#n#i3605009##z3605009# #r*10#b个 #k+#b #i3605011##z3605011# #r*10#b个\r\n"
			text += "\t金币消耗 #r*10 #b亿 #k+#b 元宝消耗 #r*100 #b点\r\n"
			text += "\t\t\t\t#r#e全职业转生奖励#n#b\r\n"
			text += "\t#n#b#i3605020##z3605020##r * 1 #b个 #k+#b #i3605007##z3605007# #r* 2 #b个\r\n"
          ...
          //cm.dispose();cm.openNpc(9900004,999);
           ...
           var c = cm.getChar();
			...
			if(cm.getPlayer().getOneTimeLogcs("转生")>=100){
			 ...
			 cm.dispose();
			}else if (!cm.haveItem(3605009, 10) ) {
				cm.sendOk("#v3605009##z3605009#不足");
				cm.dispose();
			}else if (!cm.haveItem(3605011, 10) ) {
				cm.sendOk("#v3605011##z3605011#不足");
				cm.dispose();
			}else if (!cm.haveItem(4021009, 20) ) {
				cm.sendOk("#v4021009##z4021009#不足");
				cm.dispose();
			}else if (!cm.haveItem(4011007, 20) ) {
				...
				cm.dispose();
				 ...
				 cm.setmoneyb(-100);
				 cm.gainItem(3605009, -10);
				 cm.gainItem(3605011, -10);
				 cm.gainItem(4021009, -20);
				 cm.gainItem(4011007, -20);
				 cm.gainItem(3605020, 1);
