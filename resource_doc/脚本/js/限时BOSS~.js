	...
	else 
	{
        ...
        if (status == 0) 
		{
			...
			if(cm.getPlayer().getMapId()==180000001)
			{
				...
				add += "\t  #e#L1##d"+妖僧+"#l\t   #L2#"+树精+"#l\t\t#L3#"+闹钟+"#l\r\n" ;
				add += "\t#L1#[妖 僧]#l\t#L2#[树 精]#l\t #L3#[闹 钟]#l\r\n\r\n"+群粉心+"" ;
				
				add += "\t  #L4##b"+扎昆+"#l\t   #L5#"+黑龙+"#l\t\t#L6#"+品克宾+"#l\r\n" ;
				add += "\t#L4##b[扎 昆]#l\t#L5#[黑 龙]#l\t#L6#[品克宾]#l\r\n\r\n" ;
				
				//add += "\t#L10#"+浓姬+"#l\t #L11#"+桃乐丝+"#l\t#L12#"+卡琳+"#l\r\n" ;
				//add += "\t#L10#[浓  姬]#l\t#L11#[桃乐丝]#l\t#L12#[卡  琳]#l\r\n" ;
				
				//add += "    #L17##d"+X黑白方形图标+"#r [阿卡伊勒]#l\r\n";
				//#L1##d"+都纳斯+"#l  #L1##d[都纳斯]#l    #L8##d"+路西德+"#l #L8#[路西德]#l#L9##r"+艾菲尼娅+"#l  #L9##r[艾菲尼娅]#l 
				add +="\r\n"
...
//------------------------------------------------------------------------
		...
		{
			if(selection == 1){
			   cm.openNpc(9000434,"传统BOSS1");
				}
				//cm.warp(541020800);
			if(selection == 2){
			   cm.openNpc(9000434,"传统BOSS2");
				}
				
			if(selection == 3){
			   cm.openNpc(9000434,"传统BOSS3");
				}
				
			if(selection == 4){
			   cm.openNpc(9000434,"传统BOSS4");
				}
												
			if(selection == 5){
			   cm.openNpc(9000434,"传统BOSS5");
				}
												
			if(selection == 6){
			   cm.openNpc(9000434,"传统BOSS6");
				}
