	...
	else 
	{
        ...
        if (status == 0) 
		{
			...
			if(cm.getPlayer().getMapId()==180000001)
			{
				...
				add += "\t #L1##d"+皮埃尔1+"#l\t #L2##d"+皮埃尔2+"#l\t #L3##d"+皮埃尔3+"#l\r\n" ;
				add += "\t#e#L1#[皮埃尔]#l\t#L2#[皮埃尔]#l\t#L3#[皮埃尔]#l\r\n\r\n"+群粉心+"" ;
				
				add += "\t#L4##b"+黄龙+"#l\t #L5##d"+赤虎+"#l\t #L6##d"+蛇兄弟+"#l\r\n" ;
				add += "\t#L4##b[黄  龙]#l\t#L5#[赤  虎]#l\t#L6#[蛇 兄 弟]#l \r\n\r\n"+群粉心+"" ;
				
				//add += "\t #L10#"+黑暗剑圣+"#l    #L11#"+贝德罗斯+"#l    #L12#"+麦格纳斯+"#l\r\n" ;
				//add += "\t#L10#[黑暗剑圣]#l  #L11#[贝德罗斯]#l  #L12#[麦格纳斯]#l\r\n" ;
				
				//add += "    #L17##d"+X黑白方形图标+"#r [阿卡伊勒]#l\r\n";
				//#L1##d"+天使绿水灵+"#l  #L1##d [绿水灵]#l   #L8##d"+火狐+"#l#L8#[火  狐]#l#L9##r"+黑暗饿狼+"#l  #L9##r[黑暗饿狼]#l
				add +="\r\n"
