...
Array(1115224,1115223,420,420,420,420,420,420),
Array(1115225,1115224,450,450,450,450,450,450)
);
//需求的材料和数量
var req = [
  [4021009, 199],
...
//需求的金币
var rem = 300000000;
var yuanbao = 15; // 每次进阶所需的元宝数量
var gailv = 65;//成功率 输入百分之几不要输入百分号只要数字在里面就行了!!
var sels;
var status = -1;
/* 
测试概率代码 
...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        msg += ""+提示+"#k #b进阶说明：#r成功率#r65%，进阶失败材料将会消失\r\n";
        msg += "#g-----------------------------------------------------\r\n";
