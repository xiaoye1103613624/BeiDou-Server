...
var fubenm = "福利BOSS"; //副本名称
var bossm = "绿水灵天使"; //BOSS名称
var bossid = 8880700; //BOSSID
var bossjyxs = "100万"; //BOSS经验显示
var bossjy = 100000; //BOSS经验
var bossxlxs = "1000万"; //BOSS血量显示
var bossxl = 10000000; //BOSS血量
...
var zlyq = 10000; //战力要求
var inmesoxs = "1万"; //入场金币显示
var inmeso = 10000; //入场金币
var xhwzid = 4001126; //消耗物品
var xhwzsl = 99; //消耗物品数量
var fubendt = 101071301; //副本地图
...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        text += "\t\t\t\t#b[" + fubenm + "]----#r[" + bossm + "]#k\r\n\r\n#g挑战要求：\r\n\t#k人数限制:#r " + minPartySize + " #b- #r" + maxPartySize + " #k人  等级限制:#r " + minLevel + " #b- #r" + maxLevel + " #k级 \r\n"
		text += "\t#k战力要求: #r" + zlyqxs + " #k  您当前战力: #r"+cm.getPlayer().GetCombat()/10000+" #k万\r\n"
		text += "\t#k挑战费用: #r " + inmesoxs + " #k金币  物品消耗: #r " + xhwzsl + " #k个#b#z" + xhwzid + "#\r\n"
		//text += "\t#k进入条件: 持有#r #v" + cywp + "#* 1 #k个；您拥有: #r #v" + cywp + "#* #c" + cywp + "# #k个\r\n\r\n"
        
        text += "#gBOSS介绍：\r\n\t#r[" + bossm + "]#k血量: #r" + bossxlxs + "  #k基础经验值: #r" + bossjyxs + " \r\n"
		text += "\t#k每日限挑战: #r" + TZCS + " #k次  总共限挑战: #r50 #k次\r\n\t#k今日您已挑战: #r" + cm.getBossLog(""+fubenm+"") + " #k次\t#k总共已挑战: #r"+cm.getPlayer().getOneTimeLogcs("总福利BOSS")+" #k次\r\n"
        ...
        cm.sendSimple(text);
			...
			var map = cm.getMap(fubendt)
				...
				cm.召唤怪物(bossid, bossxl, bossjy, 1, fubendt, -730,245); 
			    cm.warp(fubendt);
				//cm.刷新地图();
