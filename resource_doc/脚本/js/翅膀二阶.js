...
var itemObjS = {
	"1102378": [[4003005, 1000],[4003004, 1000],[4001006, 20],[4032056, 10], [4170007, 6],['金币', 100000000], ['点券', 30000]],
	"1102376": [[4003005, 1000],[4003004, 1000],[4001006, 20],[4032056, 10], [4170007, 6],['金币', 100000000], ['点券', 30000]],
	"1102377": [[4003005, 1000],[4003004, 1000],[4001006, 20],[4032056, 10], [4170007, 6],['金币', 100000000], ['点券', 30000]],
...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        var text = "你想拥有翅膀吗???听说在本岛帅气的人都拥有属于自己的翅膀哦~!\r\n";
            text += "当前翅膀等阶:[#r翅膀一阶#k]\r\n";
            text += "请选择你需要制作点初级翅膀[#r全属性+20#k]\r\n";
		for(var oKey in itemObjS) {
			text += "#L"+ oKey +"#兑换#v"+ oKey +"##b说明:#k[#r全属性+20#k]#k\r\n";
		}
        cm.sendSimple(text);
    } else if (status == 1) {
		...
		cm.给属性装备(selected,0,0,20,20,20,20,0,0,20,20,0,0,0,0,0,0,0);
		cm.sendOk("进阶 #v"+ selected +"##b#z"+ selected +"##k成功。");
		cm.getPlayer().指定喇叭("高质地喇叭", "系统公告", "恭喜[" + cm.getPlayer().getName() + "]成功完成翅膀2阶!");
		cm.dispose();
	}
}