...
var fubenm = "格雷德"; //副本名称
var bossm = "九大陆"; //BOSS名称+大陆扩充
var bossid = 9601939; //BOSSID
var bossjyxs = "500万"; //BOSS经验显示
var bossjy = 5000000; //BOSS经验
var bossxlxs = "500 万亿"; //BOSS血量显示
var bossxl = 500000000000000; //BOSS血量
...
var cywp = 3994731; //消耗物品
var xhwzsl = 100; //消耗物品数量
var zlyqxs = "5 亿"; //破攻要求显示
var zlyq = 500000000; //破攻要求
var fubendt = 910000254; //副本地图
...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
            ...
            text += "                 " + 图标1 + "#d 进入要求:#r #v" + cywp + "# * " + xhwzsl + " #k个" + "\r\n\r\n";
        ...
        if (msg.length > 0) {
            ...
            return;
                ...
                if (memberCheckPassed) {
                    ...
                    cm.召唤怪物(bossid, bossxl, bossjy, 1, fubendt, 1240, -28);
                    cm.warpParty(fubendt,2); // 传送队伍
                    cm.给团队每日(fubenm);
