...
var 美化1 = "#fUI/ChatBalloon.img/202/nw#"; //选择道具
var 美化3 = "#fUI/ChatBalloon.img/202/ne#"; //选择道具
var 美化2 = "#fUI/ChatBalloon.img/202/n#"; //选择道具
var 美化4 = "#fUI/ChatBalloon.img/202/sw#"; //选择道具
var 美化5 = "#fUI/ChatBalloon.img/202/se#"; //选择道具
var 美化6 = "#fUI/ChatBalloon.img/202/s#"; //选择道具
var 礼包物品 = "#v1302000#";
var 美化1 = "#fUI/ChatBalloon.img/pet/202/nw#";//选择道具
var 美化3 = "#fUI/ChatBalloon.img/pet/202/ne#";//选择道具
var 美化2 = "#fUI/ChatBalloon.img/pet/202/n#";//选择道具
var 美化4 = "#fUI/ChatBalloon.img/pet/202/sw#";//选择道具
var 美化5 = "#fUI/ChatBalloon.img/pet/202/se#";//选择道具
var 美化6 = "#fUI/ChatBalloon.img/pet/202/s#";//选择道具
...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
            var tex2 = "";
            var text = "";
            text += "#r" + 美化1 + "" + 美化2 + "" + 美化2 + "" + 美化2 + "" + 美化2 + "" + 美化2 + "" + 美化2 + "" + 美化2 + "「装备系统」#n" + 美化2 + "" + 美化2 + "" + 美化2 + "" + 美化2 + "" + 美化2 + "" + 美化2 + "" + 美化2 + "" + 美化2 + "" + 美化3 + "#k#k\r\n\r\n";
            text += " #L1##d" + 爱心7 + "T4装备合成#l    ";
            text += " \t#L2##d" + 爱心7 + "T3装备合成#l\r\n\r\n";
            text += " #L3##d" + 爱心7 + "T2装备合成#l    ";
            text += " \t#L4##d" + 爱心7 + "T1装备合成#l\r\n\r\n";
            text += " #L5##d" + 爱心7 + "T0装备合成#l    ";
            text += " \t#L6##d" + 爱心7 + "神器装备合成#l\r\n\r\n";
            /*text += " #L6##d" + 爱心7 + "T1装备合成#l    ";
            text += " \t#L66##d" + 爱心7 + "T1装备合成#l\r\n\r\n";
            text += " #L7##d" + 爱心7 + "T0装备合成#l    ";
            text += " \t#L77##d" + 爱心7 + "T0装备合成#l\r\n\r\n";
            text += " #L8##d" + 爱心7 + "神器装备合成#l    ";
            text += " #L88##d" + 爱心7 + "神器装备合成#l\r\n\r\n";*/
            text += "#r" + 美化4 + "" + 美化6 + "" + 美化6 + "" + 美化6 + "" + 美化6 + "" + 美化6 + "" + 美化6 + "" + 美化6 + "" + 美化6 + "" + 美化6 + "" + 美化6 + "" + 美化6 + "" + 美化6 + "" + 美化6 + "" + 美化6 + "" + 美化6 + "" + 美化6 + "" + 美化6 + "" + 美化6 + "" + 美化6 + "" + 美化6 + "" + 美化6 + "" + 美化5 + "#k#k\r\n";
            //

            cm.sendOk(text);
        } else if (selection == 1) {
            cm.dispose();
            cm.openNpc(9000438, "合成T4装备");
        } else if (selection == 2) {
            cm.dispose();
            cm.openNpc(9000438, "合成T3装备");
        } else if (selection == 3) {
            cm.dispose();
            cm.openNpc(9000438, "合成T2装备");
        } else if (selection == 4) {
            cm.dispose();
            cm.openNpc(9000438, "合成T1装备");
        } else if (selection == 5) {
            cm.dispose();
            cm.openNpc(9000438, "合成T0装备");
        } else if (selection == 6) {
            cm.dispose();
            cm.openNpc(9000438, "合成神器装备");
        } else if (selection == 7) {
            cm.dispose();
            cm.openNpc(9000438, "10级装备防具制作");
        } else if (selection == 8) {
            cm.dispose();
            cm.openNpc(9000438, "10级装备防具制作");
        }
