        ...
        匹配: [
            {
                ...
                技能: [//前置等级表示突破时要求的技能等级必须达到才可以突破
				    { 代码: 1000000, 前置等级: 16, 突破概率: 100 },//生命恢复
					{ 代码: 1000002, 前置等级: 8,  突破概率: 100 },//生命恢复
					{ 代码: 1001003, 前置等级: 20, 突破概率: 100 },//圣甲术
                    { 代码: 1001004, 前置等级: 20, 突破概率: 100 },//强力攻击
				    { 代码: 1001005, 前置等级: 20, 突破概率: 100 },//群体攻击
					//以上是一转
					{ 代码: 1100002, 前置等级: 30, 突破概率: 80 },//终极剑
					{ 代码: 1100003, 前置等级: 30, 突破概率: 80 },//终极斧
					{ 代码: 1101004, 前置等级: 20, 突破概率: 80 },//快速剑
					{ 代码: 1101005, 前置等级: 20, 突破概率: 80 },//快速斧
					{ 代码: 1101006, 前置等级: 20, 突破概率: 80 },//愤怒之火
					{ 代码: 1101007, 前置等级: 30, 突破概率: 80 },//伤害反击
					//以上是二转
					{ 代码: 1111002, 前置等级: 30, 突破概率: 60 },//生命加强
					{ 代码: 1111008, 前置等级: 30, 突破概率: 60 },//生命加强
					//以上是三转
					{ 代码: 1120003, 前置等级: 30, 突破概率: 40 },//生命加强
					{ 代码: 1121002, 前置等级: 30, 突破概率: 40 },//生命加强
					{ 代码: 1121010, 前置等级: 30, 突破概率: 40 },//生命加强
					{ 代码: 1121008, 前置等级: 30, 突破概率: 40 },//生命加强
					//以上是四转
                ]
            },
        ...
        匹配: [
            {
                ...
                技能: [//前置等级表示突破时要求的技能等级必须达到才可以突破
				    ...
				    { 代码: 1001005, 前置等级: 20, 突破概率: 100 },//群体攻击
					//以上是一转
					{ 代码: 1200002, 前置等级: 30, 突破概率: 80 },//终极剑
					{ 代码: 1200003, 前置等级: 30, 突破概率: 80 },//终极钝器
				    { 代码: 1201004, 前置等级: 20, 突破概率: 80 },//快速剑
					{ 代码: 1201005, 前置等级: 20, 突破概率: 80 },//快速钝器
					{ 代码: 1201007, 前置等级: 30, 突破概率: 80 },//伤害反击
					//以上是二转
					{ 代码: 1211003, 前置等级: 30, 突破概率: 60 },//烈焰之剑
					{ 代码: 1211004, 前置等级: 30, 突破概率: 60 },//烈焰钝器
					{ 代码: 1211005, 前置等级: 30, 突破概率: 60 },//寒冰之剑
					{ 代码: 1211006, 前置等级: 30, 突破概率: 60 },//寒冰钝器
					{ 代码: 1211007, 前置等级: 30, 突破概率: 60 },//雷电之剑
					{ 代码: 1211008, 前置等级: 30, 突破概率: 60 },//雷电钝器
					//以上是三转
					{ 代码: 1221002, 前置等级: 30, 突破概率: 40 },//稳如泰山
					{ 代码: 1221003, 前置等级: 20, 突破概率: 40 },//圣灵之剑
					{ 代码: 1221004, 前置等级: 20, 突破概率: 40 },//圣灵之锤
					{ 代码: 1221009, 前置等级: 30, 突破概率: 40 },//连环环破
					//以上是四转
                ]
            },
        ...
        匹配: [
            {
                ...
                技能: [//前置等级表示突破时要求的技能等级必须达到才可以突破
				    ...
				    { 代码: 1001005, 前置等级: 20, 突破概率: 100 },//群体攻击
					//以上是一转
				    { 代码: 1300002, 前置等级: 30, 突破概率: 80 },//终极枪
					{ 代码: 1300003, 前置等级: 30, 突破概率: 80 },//终极矛
				    { 代码: 1301004, 前置等级: 20, 突破概率: 80 },//快速枪
				    { 代码: 1301005, 前置等级: 20, 突破概率: 80 },//快速矛
					{ 代码: 1301007, 前置等级: 30, 突破概率: 80 },//神圣之火
					//以上是二转
					{ 代码: 1311001, 前置等级: 30, 突破概率: 60 },//枪连击
					{ 代码: 1311002, 前置等级: 30, 突破概率: 60 },//矛连击
					{ 代码: 1311003, 前置等级: 30, 突破概率: 60 },//枪连击
					{ 代码: 1311004, 前置等级: 30, 突破概率: 60 },//枪连击
					{ 代码: 1311006, 前置等级: 30, 突破概率: 60 },//龙咆哮
					//以上是三转
				    { 代码: 1320006, 前置等级: 30, 突破概率: 40 },//稳如泰山
					{ 代码: 1321002, 前置等级: 30, 突破概率: 40 },//恶龙附身
					//以上是四转
                ]
            },
    ...
    if (status == 0) {
        ...
        if (mylv >= maxLv) {
            ...
            if (技能突破概率 >= Math.floor(Math.random() * 100) + 1) {
				...
				cm.喇叭(2,"[技能突破] 玩家:<"+cm.getName()+">战士系列[技能]突破成功,当前达到："+cm.getPlayer().getSkillLevel(myskill.技能[sl2].代码)+"级,大家恭喜吧！！！");
            } else {
                //cm.teachSkill(myskill.技能[sl2].代码, mylv - 1, mylv - 1);
