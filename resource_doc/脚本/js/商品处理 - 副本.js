...
//额外允许上架的物品
var items = [
1082543,1082544,1082545,1082546,1082547,1102481,1102482,1102483,1102484,1102485,
1072743,1072744,1072745,1072746,1072747,1132174,1132175,1132176,1132177,1132178,5360015,5211060]
...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if(status == 0) {
            ...
            if(s == 1) {
                slot = selection;
                cm.sendGetNumber("请输入你要上架的数量",1,1,cm.getItem(i,slot).getQuantity());
            } else if(s == 3) {
                cm.dispose();
            ...
            if(s == 1) {
                type1 = selection;
                if(!jinbi) {
                    cm.sendGetNumber("请输入你的上架物品价格：",1,1,20000);
                } else {
