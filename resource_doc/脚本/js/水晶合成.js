/* ==================
 ...
 =====================
 */
var 邪恶小兔 = "#fEffect/CharacterEff/1112960/3/0#";  //邪恶小兔 【小】var 美化1 = "#fUI/ChatBalloon.img/pet/183/nw#";//选择道具
var 美化1 = "#fUI/ChatBalloon.img/pet/183/nw#";//选择道具
var 美化3 = "#fUI/ChatBalloon.img/pet/183/ne#";//选择道具
var 美化2 = "#fUI/ChatBalloon.img/pet/183/n#";//选择道具
var 美化8 = "#fUI/ChatBalloon.img/pet/183/head#";//选择道具
...
var 美化888 = "#fUI/CN_Chat.img/roomList/Vip#";//选择道具
var 红色箭头 = "#fEffect/CharacterEff/1082565/2/0#"; //荧光五角星
...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
			var tex2 = "";
            var text = "";
			text += ""+美化1+""+美化2+""+美化2+""+美化2+""+美化2+""+美化2+""+美化2+""+美化2+""+美化8+""+美化2+""+美化2+""+美化2+""+美化2+""+美化2+""+美化2+""+美化2+""+美化3+"\r\n"
			text += "           #v4251200# ---- #d#e五彩水晶合成#k#n ---- #v4251201# \r\n\r\n"
	        text += "\t\t#L1##d"+爱心1+" #v4251200#下等五彩水晶合成 "+制作+"#l\r\n\r\n";
		    text += "\t\t#L2##d"+爱心3+" #v4251201#中等五彩水晶合成 "+制作+"#l\r\n\r\n"
			text += "\t\t#L3##d"+爱心7+" #v4251202#高等五彩水晶合成 "+制作+"#l\r\n\r\n  "
	        // text += "#L7##r"+爱心2+" 空白选项 "+爱心2+"#l #L8##d"+爱心10+" 空白选项 "+爱心10+"#l  #L9##d"+爱心9+" 空白选项 "+爱心9+"#l \r\n\r\n"//  
            //text += "#L17##d" + 邪恶小兔 + "下等五彩水晶合成#l \r\n\r\n"//   \r\n\r\n"//
			text +=""+美化4+""+美化6+""+美化6+""+美化6+""+美化6+""+美化6+""+美化6+""+美化6+""+美化6+""+美化6+""+美化6+""+美化6+""+美化6+""+美化6+""+美化6+""+美化6+""+美化5+"";
			
			 cm.sendOk(text); 
        } else if (selection == 1) {
			cm.dispose();
            cm.openNpc(9000036,"下等五彩水晶合成"); 
        } else if (selection == 2) {
			cm.dispose();
            cm.openNpc(9000036, "中等五彩水晶合成" ); 	
		} else if (selection == 3) {
			cm.dispose();
            cm.openNpc(9000036, "高等五彩水晶合成"); 
		} else if (selection == 4) {
			cm.dispose();
			cm.openNpc(9900004, "双倍卡片"); 
			} else if (selection == 5) {
			cm.dispose();			
            cm.openNpc(9310072, "水晶合成");
			} else if (selection == 8) {
			cm.dispose();	
		    ...
		    cm.dispose();
		    cm.openNpc(9900004,604);//暮暮冒险岛指环
