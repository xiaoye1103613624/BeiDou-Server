...
Array(80,1112796,40),
Array(90,1112796,45),
Array(100,1112796,50),
Array(110,1112796,55),
Array(120,1112796,60),
Array(130,1112796,70),
Array(140,1112796,85),
Array(150,1112796,110)
)
var s
function start() {
   status = -1;
    ...
    if (status == 0) {
		...
		var text = "\r\n   " + 心 + " " + 心 + "  " + 心 + "   #r#e < 开心冒险岛 > #k#n " + 心 + "  " + 心 + "  " + 心 + " \r\n\r\n";
			...
			for(var i=0;i<items.length;i++){
				if(dj > items[i]){
					var c = cm.getBossRankCount("主线任务"+items[i]);
					if(c <1 && ss){
		...
		for(var i=0;i<奖励物品.length;i++){
			...
			if(iii[0] == items[s]){
				switch(iii[1]){
					...
					break
					default:
					cm.给属性装备(iii[1],5,0,iii[2],iii[2],iii[2],iii[2],0,0,iii[2],iii[2],0,0,0,0,0,0,0);
					break;
				}
			}
		}
		cm.setBossRankCount("主线任务"+items[s]);
