...
function action(mode, type, selection) {
    ...
    if (status == 0) {
		...
		say += "          #L0 #"+ 正方箭头 +" #k[#b“超值”限时活动礼包:#r 298元#k]#l\r\n\r\n";
		say += "          #L1 #"+ 正方箭头 +" #k[#b“超值”限时活动礼包:#r 498元#k]#l\r\n\r\n";
		say += "          #L2 #"+ 正方箭头 +" #k[#b“超值”限时活动礼包:#r 888元#k]#l\r\n\r\n";
		say += "     #k#e╰ ～～～～～～～～～～～～～～～～～～ ╯#n#l\r\n\r\n";
		say += "  "+ 红心 +" 礼包购买不限次数，截止 2026年1月30日24点 结束 "+ 红心 +"#k\r\n\r\n";
		...
		if(warp == 0){
			...
			cm.全服黄色喇叭("赞助赞助礼包 : 恭喜玩家["+cm.getPlayer().getName()+"]在赞助中心购买了298超值礼包！");
			cm.全服漂浮喇叭( "【活动礼包】恭喜土豪玩家 "+cm.getPlayer().getName()+" 购买了298元限时活动礼包！" , 5120015 );
			cm.playerMessage(1, "恭喜：领取完成！");
			Packages.tools.FileoutputUtil.log("log\\玩家相关\\“超值”298元活动礼包.log", "[" + cm.getName() + "]在赞助中心购买了298超值礼包！");
			cm.dispose();
			...
			cm.getPlayer().dropMessage(5, "赞助点：-" +金额+ "");   //红字私聊提示
			cm.getPlayer().dropMessage(5, "累计积分：+" +金额+ "");   //红字私聊提示
			cm.全服黄色喇叭("赞助赞助礼包 : 恭喜玩家["+cm.getPlayer().getName()+"]在赞助中心领取了498超值礼包！");
			cm.全服漂浮喇叭( "【活动礼包】恭喜土豪玩家 "+cm.getPlayer().getName()+" 购买了498元限时活动礼包！" , 5120015 );
			cm.playerMessage(1, "恭喜：领取完成！");
			Packages.tools.FileoutputUtil.log("log\\玩家相关\\“超值”498元活动礼包.log", "[" + cm.getName() + "]在赞助中心购买了498超值礼包！");
			cm.dispose();
		}else if(warp == 2){
		    金额 = 888;
            if(赞助 < 金额){cm.sendOk(""+正方箭头+" [ 您的赞助金额不足#r"+金额+"#k元]");cm.dispose();return;}
			...
			cm.getPlayer().dropMessage(5, "赞助点：-" +金额+ "");   //红字私聊提示
			cm.getPlayer().dropMessage(5, "累计积分：+" +金额+ "");   //红字私聊提示
			cm.全服黄色喇叭("赞助赞助礼包 : 恭喜玩家["+cm.getPlayer().getName()+"]在赞助中心领取了888超值礼包！");
			cm.全服漂浮喇叭( "【活动礼包】恭喜土豪玩家 "+cm.getPlayer().getName()+" 购买了888元限时活动礼包！" , 5120015 );
			cm.playerMessage(1, "恭喜：领取完成！");
			Packages.tools.FileoutputUtil.log("log\\玩家相关\\“超值”888元活动礼包.log", "[" + cm.getName() + "]在赞助中心购买了888超值礼包！");
			cm.dispose();
		}
	}
}
