...
[1022321,3605023,3,2047310,3,4310020,3000], //首饰
[1012760,3605023,3,2047310,3,4310020,3000],
[1122171,3605023,3,2047310,3,4310020,3000],
[1032335,3605023,3,2047310,3,4310020,3000],

]
var 成功率增益物品ID = 3605006; // 增加成功率的物品ID
var 每次物品增加的成功率 = 5; // 增加成功率的物品ID
var 每次消耗 = 150; // 增加成功率的物品ID
var 部位 = 0;
var 系数 = 1;
var 强化增加属性 =["四维","攻魔"];
var 强化上线 = 10;
var 成功率=[50,50,50,40,40,40,30,30,30,20];

var 属性 = [40, 80, 120, 160, 200, 240, 280, 320, 360, 400];

var 攻魔 = [40, 80, 120, 160, 200, 240, 280, 320, 360, 400];

var 元宝 = [40, 80, 120, 160, 200, 240, 280, 320, 360, 400];

var 点券 = [60000, 100000, 140000, 180000, 220000, 260000, 300000, 340000, 380000, 420000];

var 抵用 = [120000, 200000, 280000, 360000, 440000, 520000, 600000, 680000, 760000, 840000];
...
function action(mode, type, selection) {
    ...
    if (status == 0) {
			...
			text += "" + 感叹号 + "#d每次强化成功后#r四维+40#d、#r双攻+40#d递增.\r\n"
