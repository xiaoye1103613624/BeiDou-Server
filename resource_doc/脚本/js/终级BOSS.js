	...
	else 
	{
        ...
        if (status == 0) 
		{
			...
			if(cm.getPlayer().getMapId()==180000001)
			{
				...
				add += "\t #e#d#L1#"+光明剑灵+"#l\t#L2#"+黑暗剑灵+"#l   #L3#"+森兰丸+"#l\r\n" ;
				add += "\t#L1#[光明剑灵]#l #L2#[黑暗剑灵]#l  #L3#[森兰丸]#l\r\n\r\n"+群粉心+"" ;
				
				add += "\t #b#L4#"+方丈大师+"#l\t#L5#"+黑魔法师1+"#l  #L6#"+黑魔法师2+"#l\r\n" ;
				add += "\t#L4#[方丈大师]#l #L5#[黑魔法师]#l #L6#[黑魔法师]#l\r\n\r\n"+群粉心+"" ;
				
				//add += " #L2#"+威尔1+"#l  #L3#"+威尔2+"#l  #L12#"+敦凯尔+"#l  #L11#"+雷昂+"#l\r\n" ;
				//add += " #L2##r[威  尔]#l  #L3#[威  尔]#l   #L12#[敦凯尔]#l  #L11#[雷  昂]#l\r\n" ;
				
				//add += "    #L17##d"+X黑白方形图标+"#r [阿卡伊勒]#l\r\n";
				//#L10#"+钻机+"#l  #L9##r"+战舰+"#l  #L10##d[钻  机]#l  #L9#[战  舰]#l  
				add +="\r\n"
...
//------------------------------------------------------------------------
		...
		{
			if(selection == 1){
			   cm.openNpc(9000434,"斯乌");
				}
				
			if(selection == 2){
			   cm.openNpc(9000434,"希拉");
				}
				
			if(selection == 3){
			   cm.openNpc(9000434,"希纳斯");
				}
				
			if(selection == 4){
			   cm.openNpc(9000434,"敦凯尔");
				}
