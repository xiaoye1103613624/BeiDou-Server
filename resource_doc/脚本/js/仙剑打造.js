...
var 列表 = [
	{
		...
		制作列表: [
			{
				装备代码: 1112576, 点券: 5000000, 开放天数: 1,
				需求条件: [
					{ 物品代码: 1302900, 数量: 1 },
					{ 物品代码: 1302908, 数量: 1 },
					{ 物品代码: 1302904, 数量: 1 },
			...
			{
				装备代码: 1112575, 点券: 5000000, 开放天数: 1,
				需求条件: [
					{ 物品代码: 1402184, 数量: 2 },
					{ 物品代码: 1402142, 数量: 2 },
					{ 物品代码: 1402224, 数量: 2 },
		...
		if (status == 0) {
			...
			if (类型选择 != null) {
				...
				for (var j = 0; j < 制作选择.length; j++) {
					if (制作选择[j].开放天数 >= 读取开服天数()) {
						text += "#L" + j + "#进阶:#v" + 制作选择[j].装备代码 + ":##z" + 制作选择[j].装备代码 + "#【额外伤害+10%】#l\r\n";
					}
				}
			}
			text += "\r\n";
			...
			switch (sele2) {
				case 是:
					...
					cm.gainItem(is_2.装备代码,20, 1, 500, 500, 500, 500, 0, 0, 500, 500, 0, 0, 0, 0, 0, 0);
