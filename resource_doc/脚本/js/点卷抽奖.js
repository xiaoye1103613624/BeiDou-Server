...
Array(3015002,1000,1,1),
Array(3015027,1000,1,1),
Array(3015026,1000,1,1),
Array(3015025,1000,1,1),
Array(3015024,1000,1,1),
Array(3015023,1000,1,1),
Array(3015022,1000,1,1),
Array(3015021,1000,1,1),
Array(3015020,1000,1,1),
Array(3015019,1000,1,1),
Array(3015018,1000,1,1),
Array(3015017,1000,1,1), //遮阳椅
Array(3015016,1000,1,1),
Array(3015015,1000,1,1),
Array(3010824,1000,1,1),
Array(3010825,1000,1,1), //椰子树
Array(3010826,1000,1,1),
Array(3010827,1000,1,1), //暖暖桌
Array(3010828,1000,1,1), //玩具熊
Array(3010829,1000,1,1), //5周年枫叶纪念
...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        //  cm.getPlayer().dropTopMsg("暂时关闭抽奖 维护抽奖, 点解卡图标进行解卡暂");//cm.sendOk("背包所有栏需要留空位,当前检测位置 装备栏");
		 // if (cm.getPlayer().isGM() ) {
		    cm.sendYesNo("#r\r\n\t\t  "+抽奖中心+"\r\n\r\n\t\t\t\t#r#e #L1#"+LJ+"开始抽椅子"+LJ+"#n#l #k\r\n\r\n\r\n#d单次抽奖需要消耗#r1000点卷#d，奖池物品如下：\r\n"+text);//   #r#L1#"+LJ+"点卷单次抽奖"+LJ+"#l          #L2#"+LJ+"点卷十连抽"+LJ+"#l   
...
//}else{
        ...
        if (finalitem.length != 0) {
            ...
            if (cm.canHold(itemId,1)) {
				cm.gainNX(-点卷抽奖);
         cm.gainGachaponItem(itemId, quantity,  "点卷抽奖中心！",1);
				//cm.setmoneyb(-点卷抽奖) 
