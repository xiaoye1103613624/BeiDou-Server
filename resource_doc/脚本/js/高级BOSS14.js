...
var bossm = "神者塞伦(二阶)"; //BOSS名称
var bossid = 8880603; //BOSSID
var fubendt = 410000124; //副本地图
var fubenzb1 = 769; //副本坐标
var fubenzb2 = 158; //副本坐标
var bossjyxs = "2亿"; //BOSS经验显示
var bossjy = 200000000; //BOSS经验
var bossxlxs = "40亿"; //BOSS血量显示
var bossxl = 4000000000; //BOSS血量
var minLevel = 120; //最低等级
var maxLevel = 250; //最高等级
var minPartySize = 1; //最低人数
var maxPartySize = 1; //最高人数
var TZCS = 6; //限制次数
var zlyqxs = "100万"; //战力要求显示
var zlyq = 1000000; //战力要求
var inmesoxs = "5亿"; //入场金币显示
var inmeso = 500000000; //入场金币
var xhwzid = 4110001; //消耗物品
