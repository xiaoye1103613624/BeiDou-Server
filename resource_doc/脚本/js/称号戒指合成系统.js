...
var 列表 = [
	{
		...
		制作列表: [
			{
				装备代码: 1112017, 金币: 1000000, 开放天数: 1,
				需求条件: [
					{ 物品代码: 1112020, 数量: 2 },
					{ 物品代码: 1112021, 数量: 2 },
					{ 物品代码: 1112019, 数量: 2 },
		...
		/*	{
				装备代码: 1112575, 金币: 1000000, 开放天数: 1,
				需求条件: [
					{ 物品代码: 1402184, 数量: 2 },
					{ 物品代码: 1402142, 数量: 2 },
					{ 物品代码: 1402224, 数量: 2 },
	...
	if (mode == -1) {
		...
		if (status == 0) {
			...
			if (类型选择 != null) {
				...
				for (var j = 0; j < 制作选择.length; j++) {
					if (制作选择[j].开放天数 >= 读取开服天数()) {
						text += "#L" + j + "#进阶:#v" + 制作选择[j].装备代码 + ":##z" + 制作选择[j].装备代码 + "#【额外伤害+50%】#l\r\n";
					}
				}
			}
			text += "\r\n";
			...
			if (检测F1坐标 == false) {
				...
				text += "\t 制作道具：#v" + is_2.装备代码 + ":##b#z" + is_2.装备代码 + "##r[全属性+1888]#d\r\n";
				text += " #g┗━━━━━━━━━━━━━━━━━━━━━━━━┛#d\r\n\r\n";
