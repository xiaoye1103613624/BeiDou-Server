...
var fubenm = "阿尔卡努斯"; //副本名称
var bossm = "九大陆"; //BOSS名称+大陆扩充
var bossid = 9500652; //BOSSID 8880500
...
var zlyqxs = "永恒"; //战力要求显示
var zlyq = 22; //仙级要求最高21
var fubendt = 300040013; //副本地图
        ...
        if (msg.length > 0) {
            ...
            return;
                ...
                if (memberCheckPassed) {
                    ...
                    cm.召唤怪物(bossid, bossxl, bossjy, 1, fubendt, -7, 305);
