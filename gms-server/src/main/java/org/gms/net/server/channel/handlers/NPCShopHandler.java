...
public final class NPCShopHandler extends AbstractPacketHandler {
    ...
    public void handlePacket(InPacket p, Client c) {
        ...
        case 1: { // sell ;)
            ...
            int itemId = p.readInt();
            short quantity = p.readShort();
            // Soft itemId: used to resolve inventory tab / relocate after invent desync.
            // Do NOT strict-reject on mismatch — v083 extended-equip sell entries often
            // cache a garbage itemId while slot (and client-fixed id) are authoritative.
