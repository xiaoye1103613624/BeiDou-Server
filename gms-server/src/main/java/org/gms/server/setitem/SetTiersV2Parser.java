...
public final class SetTiersV2Parser {
    ...
    public static SetBonus parseTierObject(JSONObject tier) {
        ...
        if (bonus.getCombatStat(CombatStatType.FINAL_DAM_R) == 0 && bonus.finalDamagePercent != 0) {
            bonus.putCombatStat(CombatStatType.FINAL_DAM_R.getKey(), bonus.finalDamagePercent);
        }
    ...
    public static SetBonus parseEffectTier(Data tierNode) {
        ...
        } else if (bonus.finalDamagePercent > 0) {
            bonus.putCombatStat(CombatStatType.FINAL_DAM_R.getKey(), bonus.finalDamagePercent);
        }
