...
public final class SpiritSkillRemap {
    ...
    /** 冲锋队长「勇士的意志」：Buccaneer 常量表内无此项，用字面量。 */
    private static final int BUCCANEER_HEROS_WILL = 5121008;
    ...
    private static int herosWillOf(int jobId) {
        ...
        return switch (job / 100) {
            ...
            case 51 -> BUCCANEER_HEROS_WILL;
            case 52 -> Corsair.HEROS_WILL;
