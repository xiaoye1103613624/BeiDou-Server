 ...
 * <p>
 * 数值与 NPC 脚本 {@code scripts-zh-CN/npc/xy/匠人街/灵韵觉醒.js} 直接耦合，
 * 脚本通过 {@code Java.type('org.gms.spirit.SpiritAwakenConfig')} 读取本类常量，
 * 因此常量名不可随意变更。
 */
public final class SpiritAwakenConfig {
    ...
    public static final long COST_MESO = 5_000_000;
    ...
    public static final long RESET_COST_MESO = 1_000_000;
