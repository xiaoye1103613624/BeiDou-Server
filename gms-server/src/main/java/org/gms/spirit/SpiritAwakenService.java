...
/**
 * 灵韵觉醒门面：供 NPC 脚本（{@code xy/匠人街/灵韵觉醒.js}）调用。
 * <p>
 * 觉醒结果只写装备上的 {@code equipSkillId / equipSkillLevel / equipSkillExpire}，
 * 由 {@code ItemFactory} 落库，穿戴时经 {@link SpiritWearSkills#sync} 生效。
 */
public final class SpiritAwakenService {
    private SpiritAwakenService() {}

    /** 觉醒/重置结果；脚本侧读取 {@code message()}。 */
