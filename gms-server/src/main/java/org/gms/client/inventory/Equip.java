...
public class Equip extends Item {
    ...
    /** Coloring Prism (weapontint): body HSV, then effect-layer HSV. */
    ...
    public void setTintHue(short v) { this.tintHue = v; }
    public void setTintChroma(byte v) { this.tintChroma = v; }
    public void setTintBright(byte v) { this.tintBright = v; }
    public void setTintFxHue(short v) { this.tintFxHue = v; }
    public void setTintFxChroma(byte v) { this.tintFxChroma = v; }
    public void setTintFxBright(byte v) { this.tintFxBright = v; }
