...
public final class ExpTable {
    ...
    private static final long EXP_NEEDED_CAP = 9_000_000_000_000_000L;

    /** Indices 0..299: exp needed while at that level to advance. */
    ...
    static {
        long[] base = {
                15, 15, 34, 57, 92, 135, 372, 560, 840, 1144, 1242, 1573, 2144, 2800, 3640, 4700, 5893, 7360, 9144, 11120,
        ...
        exp = new long[MAX_LEVEL];
        System.arraycopy(base, 0, exp, 0, base.length);
        for (int i = base.length; i < MAX_LEVEL; i++) {
            exp[i] = Math.min((long) (exp[i - 1] * 1.08 + 1200), EXP_NEEDED_CAP);
        }
    }
