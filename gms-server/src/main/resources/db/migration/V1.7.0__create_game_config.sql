...
values ('world', '0', 'java.lang.Integer', 'flag', '0', '0=普通大区，1=活动大区，2=新区，3=热门大区(0=nothing,1=event,2=new,3=hot)'),
       ('world', '0', 'java.lang.String', 'server_message', 'Welcome to XiaoYe!', '顶部滚动信息(top scrolling information)'),
       ('world', '0', 'java.lang.String', 'event_message', 'XiaoYe', '大区描述(world description)'),
       ('world', '0', 'java.lang.String', 'recommend_message', 'Welcome to XiaoYe!', '大区推荐信息(world recommend information)'),
