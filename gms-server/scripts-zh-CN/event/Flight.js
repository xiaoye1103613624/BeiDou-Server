...
function scheduleNew() {
    em.getChannelServer().getMapFactory().getMap(200000131).setDocked(true);
    em.getChannelServer().getMapFactory().getMap(240000110).setDocked(true);
...
function takeoff() {
    ...
    em.getChannelServer().getMapFactory().getMap(200000131).setDocked(false);
    em.getChannelServer().getMapFactory().getMap(240000110).setDocked(false);
