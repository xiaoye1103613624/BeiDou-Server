...
var 商城 = [
	{ 代码: 3994789, 价格: 1500, 数量: 1, 类型: "积分" },
    { 代码: 3994789, 价格: 15000, 数量: 10, 类型: "积分" },
	{ 代码: 3994789, 价格: 150000, 数量: 100, 类型: "积分" },
	{ 代码: 3994789, 价格: 1500000, 数量: 1000, 类型: "积分" },
	...
	if (mode == -1) {
		...
		//	text += "\t#d" + 广播 + " 远征副本所有BOSS共享一个扩充次数\r\n";
			...
			switch (标题) {
				...
				case "副本扩充": text += 扩充次数A(); break;
				case "分解": text += 分解装备A(); break;
				case "门票商店": text += 商城购买A(选择1); break;
				default:
					break;
			}
			cm.sendYesNo(text);
			...
			switch (标题) {
				...
				case "副本扩充": 扩充次数B(); start(); break;
				case "分解": 分解装备B(sele1); start(); break;
				case "门票商店": 选择1 = 商城购买B(sele1, 选择1); start(); break;
					break;
				default:
					break;
			}
