...
var itemObjS = {
	"1102702": [[4003005, 1000],[4003004, 1000],[4001006, 40],[4032056, 20], [4170007, 10],['金币', 100000000], ['点券', 50000]],
	"1102703": [[4003005, 1000],[4003004, 1000],[4001006, 40],[4032056, 20], [4170007, 10],['金币', 100000000], ['点券', 50000]],
...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        var text = "你想拥有翅膀吗???听说在本岛帅气的人都拥有属于自己的翅膀哦~!\r\n";
            text += "当前翅膀等阶:[#r翅膀二阶#k]\r\n";
            text += "请选择你需要制作点初级翅膀[#r全属性+30#k]\r\n";
		for(var oKey in itemObjS) {
			text += "#L"+ oKey +"#兑换#v"+ oKey +"##b说明:#k[#r全属性+30#k]#k\r\n";
		}
        cm.sendSimple(text);
    } else if (status == 1) {
		...
		cm.给属性装备(selected,0,0,30,30,30,30,0,0,30,30,0,0,0,0,0,0,0);
		cm.sendOk("进阶 #v"+ selected +"##b#z"+ selected +"##k成功。");
		cm.getPlayer().指定喇叭("高质地喇叭", "系统公告", "恭喜[" + cm.getPlayer().getName() + "]成功完成翅膀3阶!");
		cm.dispose();
	}
}