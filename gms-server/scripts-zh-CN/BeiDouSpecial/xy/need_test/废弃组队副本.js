...
var 事件配置 = "KerningPQ";
var 人数 = {min: 3, max: 6};
var 等级 = {min: 18, max: 255};
var 队长奖励加倍等级 = 251;
var 限制次数 = 8;
var 限制招募 = 5;
//var 扫荡物品 = 4110000;
var 扫荡物品 = 4321029;
var 地图控制 = {领奖: 103000804};

var 介绍编辑 = [
    {内容: "[#b提示#k]:废弃第一关卡进行了优化处理"},
    {内容: "#kNpc问答“#r问题#k”都只需要#b15#k张卡完成"},
    {内容: "#r带队福利#k"},
    {内容: "#k队长等级大于等于#r251#k级即可领取#r双倍奖励#k~"},
]
var 奖励列表 = [
            ...
            switch (selection) {
                ...
                case 2:
                    ...
                    if (副本招募 >= 限制招募) {
                        ...
                        cm.getPlayer().setBossLog("副本招募", 1);
