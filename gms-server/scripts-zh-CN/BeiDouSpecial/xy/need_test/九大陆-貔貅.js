...
var zlyqxs = "1000 万"; //战力要求显示
var zlyq = 1; //战力要求
var fubendt = 450012210; //副本地图
            ...
            return;
                ...
                while (it.hasNext()) {
                    ...
                    if (chr == null) {
                        ...
                        var inventory = chr.getInventory(MapleInventoryType.SETUP);  //这个ETC是背包其他栏，SETUP是背包设置栏，消耗道具使用 MapleInventoryType.USE 来检查
                ...
                if (memberCheckPassed) {
                    ...
                    cm.召唤怪物(bossid, bossxl, bossjy, 1, fubendt, 99, 29);
