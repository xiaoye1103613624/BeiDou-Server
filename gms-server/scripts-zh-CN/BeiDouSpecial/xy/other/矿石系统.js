...
var advancedRecipes = Array(
    { target: 4011007, name: "月石", materials: [4011000, 4011001, 4011002, 4011003, 4011004, 4011005, 4011006, 4011008] },    //金属类高级矿(青铜/钢铁/锂矿石/朱矿石/银/紫矿石/黄金/锂)各1个 -> 月石
    { target: 4021009, name: "星石", materials: [4021000, 4021001, 4021002, 4021003, 4021004, 4021005, 4021006, 4021007, 4021008] }    //宝石类高级宝石(石榴石/紫水晶/海蓝宝石/祖母绿/蛋白石/蓝宝石/黄晶/钻石/黑水晶)各1个 -> 星石
);
...
var categoryNames = ["矿石合成(母矿->高级矿/水晶)", "高级矿石合成(多种高级矿/宝石各1个->星石/月石)", "锻造石合成", "勇者之石/圣者之石互换(1:1)"];
// 各分类每个合成/互换单位收取的金币手续费(实际收取 = 该值 * 数量)
var categoryFee = [100000, 500000, 1000000, 50000];
