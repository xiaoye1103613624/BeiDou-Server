...
var fubenm = "挑战欧碧啦"; //副本名称
var bossm = "魔法庭院"; //BOSS名称+大陆扩充
var bossid = 8220012; //BOSSID
var bossjyxs = "500万"; //BOSS经验显示
var bossjy = 5000000; //BOSS经验
var bossxlxs = "1200 亿"; //BOSS血量显示
var bossxl = 120000000000; //BOSS血量
...
var xhwzsl = 15; //消耗物品数量
var zlyqxs = "800 万"; //破攻要求显示
var zlyq = 8000000; //破攻要求
var fubendt = 861000050; //副本地图970000106
        ...
        if (msg.length > 0) {
            ...
            return;
                ...
                if (memberCheckPassed) {
                    ...
                    cm.召唤怪物(bossid, bossxl, bossjy, 1, fubendt, 200, -16);
            //        cm.warpParty(fubendt); // 传送队伍
                    cm.给团队每日(fubenm);
