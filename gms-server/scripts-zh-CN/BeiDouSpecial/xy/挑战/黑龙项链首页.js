...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
			...
			text += "#用你强大的实力去争取一个#v1122076##z1122076#吧！\r\n\r\n";
			text += "#L1##d"+爱心1+"#v1122076##z1122076##r[力50敏智运30攻击力30]#d#l\r\n\r\n";
			text += "#L2##d"+爱心1+"#v1122076##z1122076##r[敏50力智运30攻击力30]#d#l\r\n\r\n";
			text += "#L3##d"+爱心1+"#v1122076##z1122076##r[智50力敏运30攻击力30]#d#l\r\n\r\n";
			text += "#L4##d"+爱心1+"#v1122076##z1122076##r[运50力敏智30攻击力30]#d#l\r\n\r\n";
			...
			cm.dispose();
            cm.openNpc(9310072,"黑龙力量");
        } else if (selection == 2) {
			cm.dispose();
            cm.openNpc(9900004, "黑龙敏捷"); 			
		} else if (selection == 3) {
			cm.dispose();
            cm.openNpc(9310072, "黑龙智力");
		} else if (selection == 4) {
			cm.dispose();
            cm.openNpc(9310072, "黑龙运气");
		}  
    }
}