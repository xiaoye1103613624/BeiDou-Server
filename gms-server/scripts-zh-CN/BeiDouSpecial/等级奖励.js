...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
           ...
           text += "嗨,尊敬的[#b#h]#]\r\n"//3
           text += "#b广告提示;\r\n"
		   text += "领取礼包前请先整理背包空间至少每个栏位保留8个空位,\r\n"
		   text += "否则后果自负!#e\r\n"

           text += "#L1#" + 爱心 + " #r 30级 变强成长礼包#v4001126# [点击领取]" + 爱心 + "#l\r\n"//3
           text += "#L2#" + 爱心 + " #r 70级 变强成长礼包#v4001126# [点击领取]" + 爱心 + "#l\r\n"//3
           text += "#L3#" + 爱心 + " #r120级 变强成长礼包#v4001126# [点击领取]" + 爱心 + "#l\r\n"//3
           text += "#L4#" + 爱心 + " #r200级 变强成长礼包#v4001126# [点击领取]" + 爱心 + "#l\r\n"//3
           text += "#L5#" + 爱心 + " #r250级 变强成长礼包#v4001126# [点击领取]" + 爱心 + "#l\r\n"//3
	...
	if (cm.getPlayerStat("LVL") >= 30  && cm.getPlayer().getOneTimeLog("变强成长礼包1") <20){
		cm.getPlayer().setOneTimeLog("变强成长礼包1");//给永久记录
	...
	if(cm.getPlayerStat("LVL") >= 70 && cm.getPlayer().getOneTimeLog("变强成长礼包2") < 20){
			cm.getPlayer().setOneTimeLog("变强成长礼包2");//给永久记录
			cm.gainItem(4001126, 200);//500个枫叶
            cm.gainItem(2000005, 100);//超级药水
	...
	if(cm.getPlayerStat("LVL")>= 120 && cm.getPlayer().getOneTimeLog("变强成长礼包3") < 20){
			cm.getPlayer().setOneTimeLog("变强成长礼包3");//给永久记录
			cm.gainItem(4001126, 200);//500个枫叶
            cm.gainItem(2000005, 100);//超级药水
	...
	if(cm.getPlayerStat("LVL") >= 200 && cm.getPlayer().getOneTimeLog("变强成长礼包4") < 20){
	cm.getPlayer().setOneTimeLog("变强成长礼包4");//给永久记录
			cm.gainItem(4001126, 200);//500个枫叶
            cm.gainItem(2000005, 100);//超级药水
	...
	if(cm.getPlayerStat("LVL") >= 250 && cm.getPlayer().getOneTimeLog("变强成长礼包5") < 20){
			cm.getPlayer().setOneTimeLog("变强成长礼包5");//给永久记录
			cm.gainItem(4001126, 200);//500个枫叶
	...
	if(cm.getPlayerStat("LVL") >= 120 && cm.getPlayer().getOneTimeLog("变强成长礼包6") < 1){
			cm.getPlayer().setOneTimeLog("变强成长礼包6");//给永久记录
			cm.gainItem(4001126, 200);//500个枫叶
	...
	if(cm.getPlayerStat("LVL") >= 130 && cm.getPlayer().getOneTimeLog("变强成长礼包7") < 1){
			cm.getPlayer().setOneTimeLog("变强成长礼包7");//给永久记录
	...
	if(cm.getPlayerStat("LVL") >= 140 && cm.getPlayer().getOneTimeLog("变强成长礼包8") < 1){
			cm.getPlayer().setOneTimeLog("变强成长礼包8");//给永久记录
			cm.gainItem(4001126, 300);//500个枫叶
			cm.gainMeso(5000000 );//给与金币
            cm.gainItem(2000005, 200);//超级药水
			cm.gainDY(10000)//抵用3000点
