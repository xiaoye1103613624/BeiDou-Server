...
function action(mode, type, selection) {
    ...
    if (status == 0) {
		...
		qm.sendNext("You're powerful, aren't you? I think it's time to settle things!", 2159308);
    } else if (status == 1) {
		...
		qm.sendNext("You're stronger than I thought! How amusing!");
    } else if (status == 2) {
		...
		qm.sendDirectionStatus(1, 1500);
		qm.sendNext("Ah, it seems the Black Mage wishes to see you after all! I'll expect to see you again!", 2159308);
	} else if (status == 3) {
