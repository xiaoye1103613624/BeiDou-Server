...
function start(mode, type, selection) {
	...
	if (status == 0) {
        ...
        qm.sendNextPrev("The Crew Boss can invite any characters created\r\nbetween 12/4 and 12/31 to their Crew, then help them reach Level 100 (Lv. 180 for Zero) to earn #i4310088:# #e#b#t4310088#(50)#k#n.\r\nIf the Crew Member reaches their target on time, they'll earn\r\n1. #i4310088:# #e#b#t4310088#(25)#k#n\r\n2. #i5150052:# #e#b#t5150052##k#n\r\n3. #i5150056:# #e#b#t5150056##k#n\r\n4. #i5151035:# #e#b#t5151035##k#n",5);	
	} else if (status == 2) {	
	    qm.sendNextPrev("The Crew Boss can invite up to 3 members to join their Crew, and if everyone reaches their target level by 01/31/2014, the Crew Boss will get an immediate boost of #e#bMaple Point : 10000#k#n Amazing, right?",5);	
	} else if (status == 3) {	
	    qm.sendNextPrev("On top of that, all 4 members of the Crew will get these awesome rewards!\r\n1. #i1114000:# #e#b#t1114000##k#n\r\n2. #i1142668:# #e#b#t1142668##k#n\r\n3. #i5010115:# #e#b#t5010115##k#n",5);
	} else if (status == 4) {	
        qm.sendNextPrev("Oh, and if the Crew Boss succeed in inviting a Mapler that has never participated in the #e#bAll 4 One Event#k#n,\r\n the Crew Member will get #i2450067:# #e#b#t2450067#(3)#k#n. It pays to help a newbie!",5);	
	} else if (status == 5) {	
        qm.sendNextPrev("Cool, huh? You should get your own Crew together and do your best to help each other win! All for one!",5);		
	} else if (status == 6) {	
        qm.sendNextPrev("You are eligible to be a Crew Member!\r\nFind yourself a Crew Boss and team up with your fellow Maplers to earn excellent rewards!",5);		
	} else if (status == 7) {	
