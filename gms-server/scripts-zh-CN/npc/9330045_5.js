...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
            ...
            var gsjb = "";
            gsjb = "\t\t"+彩虹+"  #e#d 钓 鱼 兑 换 #k#n  #r  "+彩虹+"#b#k#n\r\r\n"+中条猫+中条猫+中条猫+中条猫+中条猫+中条猫+中条猫+中条猫+中条猫+中条猫+中条猫+中条猫+中条猫+中条猫+中条猫+中条猫+中条猫+中条猫+中条猫+中条猫+中条猫+中条猫+中条猫+"\r\n\n";
            //gsjb += "#L16##r"+红色箭头+"快速小鱼换大鱼(10万手续费)#v4031636##v4031640##v4031644##v4031648##k#l\r\n\r\n";
			gsjb += "#L10011##r"+红色箭头+"小鱼换大鱼\r\n\r\n";
			
			gsjb += "#L10012##r"+红色箭头+"大鱼换奖励\r\n\r\n";
