...
var itemObjS = {
	"1003552": [ [4170016, 1], [4000464, 2], [4310143, 5], [4021009, 10],[4011007, 10],['金币', 30000000],['进阶', 1003946],['属性', 10,10,10,10,10,10]], //帽子
	"1052461": [ [4170016, 1], [4000464, 2], [4310143, 5], [4021009, 10],[4011007, 10],['金币', 30000000],['进阶', 1052647],['属性', 10,10,10,10,10,10]], //衣服
	"1072666": [ [4170016, 1], [4000464, 2], [4310143, 5], [4021009, 10],[4011007, 10],['金币', 30000000],['进阶', 1072853],['属性', 10,10,10,10,10,10]], //靴子
	"1082433": [ [4170016, 1], [4000464, 2], [4310143, 5], [4021009, 10],[4011007, 10],['金币', 30000000],['进阶', 1082540],['属性', 10,10,10,10,10,10]], //手套
	"1102441": [ [4170016, 1], [4000464, 2], [4310143, 5], [4021009, 10],[4011007, 10],['金币', 30000000],['进阶', 1102612],['属性', 10,10,10,10,10,10]], //披风
	"1132154": [ [4170016, 1], [4000464, 2], [4310143, 5], [4021009, 10],[4011007, 10],['金币', 30000000],['进阶', 1132242],['属性', 10,10,10,10,10,10]], //腰带
	
	"1092022": [ [4170016, 1], [4000464, 2], [4310143, 5], [4021009, 10],[4011007, 10],['金币', 30000000],['进阶', 1099002],['属性', 10,10,10,10,10,10]], //盾牌
	
	"1302227": [ [4170016, 1], [4000464, 2], [4310143, 5], [4021009, 10],[4011007, 10],['金币', 30000000],['进阶', 1302289],['属性', 10,10,10,10,10,10]], //单手剑
	"1402151": [ [4170016, 1], [4000464, 2], [4310143, 5], [4021009, 10],[4011007, 10],['金币', 30000000],['进阶', 1402210],['属性', 10,10,10,10,10,10]], //双手剑
	"1432138": [ [4170016, 1], [4000464, 2], [4310143, 5], [4021009, 10],[4011007, 10],['金币', 30000000],['进阶', 1432178],['属性', 10,10,10,10,10,10]], //枪
	"1442173": [ [4170016, 1], [4000464, 2], [4310143, 5], [4021009, 10],[4011007, 10],['金币', 30000000],['进阶', 1442234],['属性', 10,10,10,10,10,10]], //矛
	"1382168": [ [4170016, 1], [4000464, 2], [4310143, 5], [4021009, 10],[4011007, 10],['金币', 30000000],['进阶', 1382222],['属性', 10,10,10,10,10,10]], //长杖
	"1452170": [ [4170016, 1], [4000464, 2], [4310143, 5], [4021009, 10],[4011007, 10],['金币', 30000000],['进阶', 1452216],['属性', 10,10,10,10,10,10]], //弓
	"1462159": [ [4170016, 1], [4000464, 2], [4310143, 5], [4021009, 10],[4011007, 10],['金币', 30000000],['进阶', 1462204],['属性', 10,10,10,10,10,10]], //弩
	"1472179": [ [4170016, 1], [4000464, 2], [4310143, 5], [4021009, 10],[4011007, 10],['金币', 30000000],['进阶', 1472226],['属性', 10,10,10,10,10,10]], //拳套
	"1332193": [ [4170016, 1], [4000464, 2], [4310143, 5], [4021009, 10],[4011007, 10],['金币', 30000000],['进阶', 1332238],['属性', 10,10,10,10,10,10]], //短刀
	"1482140": [ [4170016, 1], [4000464, 2], [4310143, 5], [4021009, 10],[4011007, 10],['金币', 30000000],['进阶', 1482179],['属性', 10,10,10,10,10,10]], //指节
	"1492152": [ [4170016, 1], [4000464, 2], [4310143, 5], [4021009, 10],[4011007, 10],['金币', 30000000],['进阶', 1492190],['属性', 10,10,10,10,10,10]], //短枪
...
function action(mode, type, selection) {
    ...
    if (status == 0) {
		...
		for(var oKey in itemObjS) {
			text += "#L"+ oKey +"#"+制作+"     #v"+ oKey +"##b#z"+ oKey +"# "+小lv+""+小lv数字9+""+小lv数字9+"#k\r\n\r\n";
		}
		...
		var 是否101 = "#r未满足 "+开+"#k"; 
			...
			text += "#r" +美化4+""+美化6+""+美化6+""+美化6+""+美化6+""+美化6+""+美化6+""+美化6+""+美化6+""+美化6+""+美化6+""+美化6+""+美化6+""+美化6+""+美化6+""+美化5+"#k#k\r\n";
		        ...
		        text += "         "+蓝枫+"[#d #v"+ selection +"##b#z"+ selection +"# "+小lv+""+小lv数字9+""+小lv数字9+""+右边框+" "+装备+" ]#k\r\n\r\n";
		// text += "\r\n     "+向下+" "+向下+" "+向下+" "+向下+"  "+向下+" "+向下+" "+向下+" "+向下+" "+向下+" "+向下+"#n#k\r\n";
		        text += "       [ "+向下+" #d所有属性将会继承到#r新装备上#d"+向下+" ] #n#k\r\n";
		        text += "       [ "+向下+" #d[可强化次数]恢复为#r全新次数#d"+向下+" ] #n#k\r\n";
		        text += "         "+红枫+"[ #v"+needItems[i][1]+"##r#z"+needItems[i][1]+"# "+小lv+""+小lv数字7+""+小lv数字0+""+右边框+" "+装备+" #k]#k\r\n";
			} else {
		...
		for(var i = 0; i < needItems.length; i++) {
				item2.setFlag(1);//上锁
				item2.setStr(item1.getStr()+10);  //力量
                item2.setDex(item1.getDex()+10);  //敏捷
                item2.setInt(item1.getInt()+10);  //智力
                item2.setLuk(item1.getLuk()+10); //运气----四维
                item2.setHp(item1.getHp());
                item2.setMp(item1.getMp());
                item2.setWatk(item1.getWatk()+10);//攻击力
                item2.setMatk(item1.getMatk()+10);//魔法力
                item2.setWdef(item1.getWdef()+10); //物防
                item2.setMdef(item1.getMdef()+10); //模仿
				item2.setAcc(item1.getAcc()+10); //命中
                item2.setAvoid(item1.getAvoid()+10); //回避
