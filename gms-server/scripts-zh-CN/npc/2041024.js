...
var fubenm = "闹钟BOSS"; //副本名称
var bossm = "传统BOSS"; //BOSS名称
var bossid = 8500001; //BOSSID
var bossjyxs = "500万"; //BOSS经验显示
var bossjy = 5000000; //BOSS经验
var bossxlxs = "2 亿"; //BOSS血量显示
var bossxl = 200000000; //BOSS血量
...
var xhwzsl = 1; //消耗物品数量
var zlyqxs = "1 万"; //战力要求显示
var zlyq = 10000; //战力要求
var fubendt = 220080001; //副本地图
var FBSJ = 1800; //限制时间 秒
var FBSJXS = 30; //显示时间分钟
//var cishuxianzhi = 5; //限时的限制次数
var inmeso = 1; //入场金币
        ...
        if (msg.length > 0) {
            ...
            return;
                ...
                if (memberCheckPassed) {
                    ...
                    cm.召唤怪物(bossid, bossxl, bossjy, 1, fubendt, -395, -386);
