...
var jiage = -1;
	...
	if (mode == 1) {
        ...
        if (status == 0) {
            ...
            gsjb += "#L3##e#b立即突破#v2614000##z2614000##r[Hot]#l\r\n";
            cm.sendSimple(gsjb);
        } else if (status == 1) {
            if (selection == 3) {
            ...
            if (cm.haveItem(2614000,selection) && ((cm.getChar().getPGSXDJ()*10000)+199999) <= 210000000) {//判断最高突破多少
                    ...
                    cm.sendNext("您的输入的数量错误，无法突破伤害上限。或者你已经达到最高值了");
                    cm.dispose();
                }
			} 
        }
