...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {		
            var add =         " \t\t"+彩虹+"  #e#d 氪 金 中 心 #k#n  #r  "+彩虹+"#b#k#n\r\r\n";
...
add +=   "#L1#"+皇冠白+"元宝装备#l     #L2#"+皇冠白+"元宝坐骑#l    #L3#"+皇冠白+"时装升星#l\r\n\r\n";
...
//------------------------------------------------------------------------
			 ...
			 if (selection == 1) {
				cm.dispose();
				cm.openNpc(9270063, 元宝装备);
        }	
            if (selection == 2) {
				cm.dispose();
				cm.openNpc(9270063, "元宝坐骑");
        }		
		    if (selection == 3) {
				cm.dispose();
				cm.openNpc(9270063, "时装升星");
        }			          
        }
    }
}
