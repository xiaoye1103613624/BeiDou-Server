   ...
   status--;
	...
	//text += "     \r\n"
        cm.sendSimple(text);
            ...
            cm.dispose();
        }else if(cm.haveItem(1102074,1) && cm.haveItem(4000463,1200)&& cm.haveItem(4001006,500)&& cm.haveItem(4000244,200)&& cm.haveItem(4000245,200)  && cm.haveItem(4000313,2000) && cm.haveItem(4001126,2000) && cm.haveItem(4000038,100)){
				cm.gainItem(1102074, -1);
				cm.gainItem(4000313, -2000);
				cm.gainItem(4001006, -500);
				cm.gainItem(4000244, -200);
...
cm.全服黄色喇叭("[翅膀进价] : 恭喜玩家 【"+cm.getPlayer().getName()+"】 成功进价五级翅膀全属性+13，功魔+17,未来的明日之星！")
            ...
            cm.sendOk("进价翅膀材料或者不足#v1102074#X1#v4000463#X1200#v4000313#X2000#v4001126#X2000#v4000038#X100#v4001006# X 500#v4000244# X 200#v4000245# X 200\r\n");
            cm.dispose();
			}
		}
    }
