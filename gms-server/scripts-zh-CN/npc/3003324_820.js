...
function action(mode, type, selection) {
    ...
    if (status == 0) {
		...
		*/
		...
		else if(!cm.haveItem(5570000,2)) {
            cm.sendOk("每次强化需要消耗#b2#k个#i5570000，请凑足了再来！");
            cm.dispose();
        }else {
