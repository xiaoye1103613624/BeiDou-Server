...
function action(mode, type, selection) {
    ...
    if (status == 0) {
    	var txt = "#d使用金币进行抽奖，您将随机获得下面的奖励#n#k\r\n";
		txt += "#d当前金币剩余：#b"+cm.判断金币()+"\r\n";
		txt += "#d每次抽奖消耗：#b1000000金币\r\n";
		txt += "#d今日已抽次数：#b"+cm.getBossLog("金币抽奖次数")+"\r\n\r\n";
    	...
    	switch (sel0) {
			case 1:
                if (cm.判断金币()< 1000000*selection) 
				{
					cm.sendOk("金币数量不足#r "+(1000000*selection)+" #k，无法抽奖");
					cm.dispose();
					return;
				} 
				else
				{
					...
					cm.setBossLog("金币抽奖次数",1,selection);
				}
				break;
			case 2:
