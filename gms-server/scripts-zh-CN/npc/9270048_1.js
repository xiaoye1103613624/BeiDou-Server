...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
			...
			text += "#d哈喽！有没有羡慕过别人的分身翻倍伤害呢？\r\n如果有，给我1888元宝就可以让你的分身伤害提高一倍哦！#k\r\n"
			//text += "\t#L100##k[#v4170005##r#c4170005##k/35]兑换#d#fUI/Basic/BtHide3/mouseOver/0##v1912000##l\r\n\r\n"
			text += "\t#L101##k[1888元宝]兑换#v3994720#永久使用#l\r\n\r\n"
            cm.sendSimple(text);
		}else if(status ==1){
			...
			if(getmoneyb()>=1888 && cm.getPlayer().getItemQuantity(3994720,false)<1){
				setmoneyb(-1888);
			...
			cm.sendOk("元宝不足1888,或者你已经有这个东西了");
			cm.dispose();
			return;
			}
