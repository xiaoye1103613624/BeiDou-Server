...
var bossmaps = Array(
        ...
        Array(270050000,380000,"品克缤BOSS                #r（消耗38万金币）#b")		
		);
//------------------------------------------------------------------------
...
var zhongji = Array(
		...
		Array(450012010,1000000,"终极地图：黎曼            #r（消耗100万金币）#b"), 
		Array(450012010,1000000,"终极地图：绯红#r(暂未开放)  #r（消耗100万金币）#b"), 
        Array(450009200,1000000,"终极地图：月桥            #r（消耗100万金币）#b"),
        Array(350056009,1000000,"终极地图：黑色天堂         #r（消耗100万金币）#b")	
		);
//------------------------------------------------------------------------
...
var monstermaps = Array(
		...
		Array(400030500,880,"闪耀之石森林#r（880金币）#b　 　  适合 25 ~ 35 级玩家"),
		Array(103000105,980,"地铁<第4地区>#r（980金币）#b　  　适合 35 ~ 50 级玩家"), 
		Array(701010000,1180,"上海郊外1#r（1180金币）#b　 　　　适合 45 ~ 60 级玩家"),
		Array(105040306,1280,"巨人之林#r（1280金币）#b　　 　 　适合 50 ~ 65 级玩家"),	
		Array(510000300,2280,"迷雾森林入口#r（2280金币）#b 　 　适合 55 ~ 75 级玩家"),
		...
		Array(510001300,2780,"吸血鬼城堡#r（2780金币）#b　　  　适合 85 ~ 100 级玩家"), 
		Array(230040100,2880,"深海峡谷2#r（2880金币）#b　　 　　适合 90 ~ 100 级玩家"),
		Array(551030001,2980,"瓣瓣站最久的一环#r（2980金币）#b　适合 95 ~ 120 级玩家"),
		Array(401052102,3080,"实验室地下2层#r（3080金币）#b　   适合 100 ~ 120 级玩家"),
		Array(240040511,3280,"被遗忘的龙之巢#r（3280金币）#b  　适合 105 ~ 130 级玩家"),		  
		Array(541020000,3580,"噩梦时间塔#r（3580金币）#b　　  　适合 150 ~ 180 级玩家"),
		Array(410000101,8000,"狐狸村中段#r（8000金币）#b　　  　适合 200级玩家"),
		Array(410000121,8000,"守护灵的散步路#r（8000金币）#b　　适合 200级玩家")
		); 
...
var townmaps = Array(
		...
		Array(1000000,100,"彩虹岛#r         （消耗1百金币）#b"), 
		...
		Array(930000010,1000,"艾琳森林#r             （消耗1千金币）#b"),
...
//------------------------------------------------------------------------
	...
	if (selection == 999) {
		var selStr = "#d　　　　　　　　　#d#e#v4442200#终极地图#v4442200##k#b";
		for (var i = 0; i < zhongji.length; i++) {
		selStr += "\r\n#L" + i + "#" + zhongji[i][2] + "";
		}
		cm.sendSimple(selStr);
		zhongji255 = 1;
...
//------------------------------------------------------------------------
	...
	if (towns == 1) {
	  ...
	  else if (zhongji255 == 1) {
		cm.sendYesNo("你确定要去 " + zhongji[selection][2] + "?");
		chosenMap = selection;
		zhongji255 = 2;
...
//----------------------------------------------------------------------
	...
	if (towns == 2) {
		...
		cm.dispose();
				...
				else if (zhongji255 == 2) {
		if(cm.getMeso()>=zhongji[chosenMap][1]){
		cm.warp(zhongji[chosenMap][0], 0);
		cm.gainMeso(-zhongji[chosenMap][1]);
		}else{
		cm.sendOk("你没有足够的金币哦!");
		}
		cm.dispose();
