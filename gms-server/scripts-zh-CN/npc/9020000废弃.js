    ...
    if (status == 0) {
	    ...
	    cm.removeAll(4001008);
            ...
            if (cm.getMeso() >= maxjinbi){//判断多少金币
				...
				Packages.handling.world.World.Broadcast.broadcastMessage(Packages.tools.MaplePacketCreator.serverNotice(9,cm.getClient().getChannel(),"废弃副本召集令" + " : " + cm.getPlayer().getName() +" 废弃副本奖励多多,我在废弃都市等你",true));//黄色
				Packages.handling.world.World.Broadcast.broadcastMessage(Packages.tools.MaplePacketCreator.serverNotice(9,cm.getClient().getChannel(),"废弃副本召集令" + " : " + cm.getPlayer().getName() +" 废弃副本奖励多多,我在废弃都市等你",true));//黄色
				Packages.handling.world.World.Broadcast.broadcastMessage(Packages.tools.MaplePacketCreator.serverNotice(9,cm.getClient().getChannel(),"废弃副本召集令" + " : " + cm.getPlayer().getName() +" 废弃副本奖励多多,我在废弃都市等你",true));//黄色
				Packages.handling.world.World.Broadcast.broadcastMessage(Packages.tools.MaplePacketCreator.serverNotice(9,cm.getClient().getChannel(),"废弃副本召集令" + " : " + cm.getPlayer().getName() +" 废弃副本奖励多多,我在废弃都市等你",true));//黄色
				Packages.handling.world.World.Broadcast.broadcastMessage(Packages.tools.MaplePacketCreator.serverNotice(9,cm.getClient().getChannel(),"废弃副本召集令" + " : " + cm.getPlayer().getName() +" 废弃副本奖励多多,我在废弃都市等你",true));//黄色
