...
function action(mode, type, selection) {
    if (mode == 1)
        ...
        cm.dispose();
    if (status == 0 && mode == 1) {
        var selStr = "嗨，我是风云,我这里任何矿石都可以炼制,你需要炼制什么样的矿石呢？#b"
        var options = new Array("做一些矿石", "提炼一些宝石矿", "提炼一些高级宝石矿", "提炼一些高级水晶");
        ...
        if (selectedType == 0) { //mineral refine
            ...
            var selStr = "需要什么吗？？#b";
            var crystals = new Array("#t4005000#", "#t4005001#", "#t4005002#", "#t4005003#", "#t4005004#","#t4011008#");
        ...
        if (selectedType == 0) { //mineral refine
            ...
            var itemSet = new Array(4005000, 4005001, 4005002, 4005003, 4005004,4011008);
            var matSet = new Array(4004000, 4004001, 4004002, 4004003, 4004004,4010007);
            var matQtySet = new Array(10, 10, 10, 10, 10, 10);
            var costSet = new Array(1000000, 1000000, 1000000, 1000000, 1000000,1000000);
            item = itemSet[selectedItem];
            mats = matSet[selectedItem];
            matQty = matQtySet[selectedItem];
            cost = costSet[selectedItem];
