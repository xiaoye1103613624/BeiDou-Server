...
{ 类型: 2370000, 数量: 5, 目录: 30 },
{ 类型: 4001126, 数量: 700, 目录: 30 },
{ 类型: 4011001, 数量: 10, 目录: 30 },
{ 类型: 4011004, 数量: 10, 目录: 30 },
{ 类型: 0, 数量: 800000, 目录: 30 },
{ 类型: 3010045, 数量: 1, 目录: 30 },*/


{ 类型: 4000423, 数量: 1, 目录: 100 },//会员礼包1
{ 类型: 4001126, 数量: 500, 目录: 100},
//{ 类型: 3010045, 数量: 1, 目录: 100 },//椅子
//{ 类型: 1, 数量: 5888, 目录: 100 },//给点卷
//{ 类型: 1122017,力量: 10, 敏捷: 10, 智力: 10, 运气: 10, HP: 100, MP: 100, 物攻: 5, 魔攻: 5, 物防: 10, 魔防: 10, 命中: 5, 回避: 5, 移动: 5, 跳跃: 5, 交易: 1, 数量: 1, 目录: 100 },


//{ 类型: 3015100, 数量: 1, 目录: 500 },//兔椅子
//{ 类型: 5220040, 数量: 10, 目录: 500 },//飞天猪的蛋
{ 类型: 4000425, 数量: 1, 目录: 500 },//会员礼包2
{ 类型: 4001126, 数量: 1000, 目录: 500 },




{ 类型: 4000424, 数量: 1, 目录: 1000 },//会员礼包3
{ 类型: 4001126, 数量: 1500, 目录: 1000 },

//{ 类型: 4000422, 数量: 1, 目录: 3000 },//会员礼包4
//{ 类型: 4001126, 数量: 3000, 目录: 3000 },

{ 类型: 4031504, 数量: 1, 目录: 5000 },//会员礼包5
{ 类型: 4001126, 数量: 5000, 目录: 5000 },

//{ 类型: 4031505, 数量: 1, 目录: 8000 },//会员礼包5
//{ 类型: 4001126, 数量: 9999, 目录: 8000 },

{ 类型: 4031506, 数量: 1, 目录: 10000 },//终极VIP
{ 类型: 4001126, 数量: 9999, 目录: 10000 },
	...
	if (status == 0) {
		...
		for (var c = 0; c < xmxszML.length; c++) { //
			...
			if (xmxszML[c].编号 >= 领取次数) {
				text += "#L" + xmxszML[c].编号 + "#"+星星+"#e#d首次赞助消费满  [#r" + 当前充值 + "#d/" + xmxszML[c].目录 + "]\r\n\r\n"
              s++;
			}
