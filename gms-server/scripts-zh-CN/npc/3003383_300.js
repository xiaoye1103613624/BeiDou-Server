   ...
   status--;
	...
	//text += "     \r\n"
        cm.sendSimple(text);
            ...
            cm.dispose();
        }else if(cm.haveItem(1102349,1) && cm.haveItem(4000463,600) && cm.haveItem(4000313,1000) && cm.haveItem(4001126,1000)&& cm.haveItem(4000030,50)&& cm.haveItem(4000242,200)&& cm.haveItem(4001006,80)){
...
cm.全服黄色喇叭("[翅膀进价] : 恭喜玩家 【"+cm.getPlayer().getName()+"】 成功进价三级翅膀全属性+9，未来的明日之星！")
            ...
            cm.sendOk("进价翅膀材料或者不足#v1102349#X1 #v4000030# X 50#v4000463#X600 #v4000313#X1000 #v4001006# X 80#v4000242# X 200#v4001126#X1000\r\n");
            cm.dispose();
			}
		}
    }
