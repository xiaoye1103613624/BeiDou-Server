...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
		   ...
		   gsjb += "#L100##b#v4031636##z4031636#  兑换#v4001200# #b比例-(#r10 = 1#b)已拥有:#r#c4031636##k#l\r\n";
			
			gsjb += "#L101##b#v4031640##z4031640# 兑换#v4001200# #b比例-(#r5 = 1#b)已拥有:#r#c4031640##k#l\r\n";
			
            gsjb += "#L102##b#v4031644##z4031644# 兑换#v4001200# #b比例-(#r10 = 1#b)已拥有:#r#c4031644##k#l\r\n";
			
            gsjb += "#L103##b#v4031648##z4031648# 兑换#v4001200# #b比例-(#r5 = 1#b)已拥有:#r#c4031648##k#l\r\n\r\n";
          ...
          /*  if (beauty == 16) {
			...
			if (beauty == 100) {
                if (cm.haveItem(4031636, selection*10)){
					 ...
					 cm.gainItem(4001200, selection);
					 cm.gainExp(40000* selection);
                     cm.sendOk("兑换成功！");
					
				    cm.喇叭(1,"玩家：["+cm.getName()+"]钓到了大鱼！兑换了 "+selection+" 个小鱼！");
					 cm.dispose();
                } else {
                    cm.sendNext("条件不足，无法兑换。");
                    cm.dispose()
