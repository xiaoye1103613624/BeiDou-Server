...
function action(mode, type, selection) {
	...
	cm.sendNextPrev("I say, you have great foresight about these things.", 4, 2159008);
    } else if (status == 2) {
	...
	cm.sendNextPrev("Pardon? The next stage?", 4, 2159008);
    } else if (status == 4) {
	...
	cm.sendNextPrev("What?? All these test subjects... I say, sir, just what are you planning to do?", 4, 2159008);
    } else if (status == 6) {
	...
	cm.sendNextPrev("Huh? Well... Now that you mention it, I do hear something. Yes, I do hear something...", 4, 2159008);
    } else if (status == 9) {
