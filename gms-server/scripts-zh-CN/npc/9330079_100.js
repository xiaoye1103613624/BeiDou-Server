...
function action(mode, type, selection) {
    ...
    if (cm.getMapId() == 180000001) {
		...
		selStr += "#d    亲爱的玩家 #r[#h ##k#r]#d,欢迎来到 #r[" + cm.getChannelServer().getServerName() + "] #k\r\n\r\n"; 
		selStr += "  #k当前在线时间:  #b"+桃花+"  " + cm.getGamePoints() + "  分钟 \r\n";
		selStr += "  #k当前点卷余额:  #b"+桃花+"  " + cm.getPlayer().getCSPoints(1) + "  点\r\n";
		selStr += "  #k当前抵用余额:  #b"+桃花+"  " + cm.getPlayer().getCSPoints(2) + "  点\r\n";
		selStr += "  #k当前豆豆余额:  #b"+桃花+"  " + cm.getBeans() + "  点\r\n";
		selStr += "  #k当前背包金币:  #b"+桃花+"  " + cm.getMeso() + "  点\r\n";
		selStr += "  #k当前元宝余额:  #b"+桃花+"  " + cm.getmoneyb() + "  点\r\n";
		selStr += "  #k当前存款余额:  #b"+桃花+"  " + cm.getRMB() + "  亿\r\n";
		selStr += "  #k当前角色人气:  #b"+桃花+"  " + cm.getPlayer().getFame() + "  点\r\n";
