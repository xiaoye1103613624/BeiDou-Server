...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        cm.sendNext("This can't be happening...!");
    } else if (status == 3) {
        cm.sendPlayerToNpc("What did you do to me? Is this the Black Mage's energy?");
    } else if (status == 4) {
        cm.sendNext("We must capture you to avoid interrogation.");
    } else if (status == 5) {
        ...
        cm.sendNext("(Who is that? I've never seen someone so powerful.)", 2159342);
    } else if (status == 6) {
        ...
        cm.sendNext("Wait. I'm not part of them. You..who are you?", 2159342);
    } else if (status == 9) {
        cm.sendPlayerToNpc("Stay back!");
    } else if (status == 10) {
        cm.sendNext("C'mon.. You need help, you need it now. They, the Black Wings, were draining your power!", 2159342);
    } else if (status == 11) {
        ...
        cm.sendNext("I'm J, an Agent in the Resistance. We're working against the Black Wings. I don't know who you are, but I want to help you.", 2159342);
    } else if (status == 14) {
