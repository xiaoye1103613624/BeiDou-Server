...
function action(mode, type, selection) {
   ...
   status--;
	...
	//text += "     \r\n"
		...
		else if(cm.haveItem(1102184,1) && cm.haveItem(4000463,300) && cm.haveItem(4000313,600) && cm.haveItem(4001126,600)&& cm.haveItem(4001006,50)){
...
cm.全服黄色喇叭("[翅膀进价] : 恭喜玩家 【"+cm.getPlayer().getName()+"】 成功进价二级翅膀全属性+7，未来的明日之星！")
            ...
            cm.sendOk("进价翅膀材料或者不足#v1102184#X1#v4000463#X300#v4000313#X600#v4001006# X 50#v4001126#X600\r\n");
            cm.dispose();
			}
		}
    }
