    ...
    switch (status) {
        ...
        case 1: //
            if (sel != 3) {
                ...
                if (selection == 0) {
                    if (cm.getPQLog("MParkTicket1") < 10) {
                        ...
                        cm.sendOk("你今天已经购买了10张入场券了,你再确认一下。");
                    }
                } else if (selection == 1) {
                    if (cm.getPQLog("MParkTicket2") < 10) {
                    ...
                    if (cm.getPQLog("MParkTicket3") < 10) {
