...
var fubenm = "少林妖僧"; //副本名称
var bossm = "传统BOSS"; //BOSS名称
var bossid = 9600025; //BOSSID
var bossjyxs = "500万"; //BOSS经验显示
var bossjy = 5000000; //BOSS经验
var bossxlxs = "8000W"; //BOSS血量显示
var bossxl = 80000000; //BOSS血量
...
var xhwzsl = 1; //消耗物品数量
var zlyqxs = "3 万"; //战力要求显示
var zlyq = 30000; //战力要求
var fubendt = 702060000; //副本地图
        ...
        if (msg.length > 0) {
            ...
            return;
                ...
                if (memberCheckPassed) {
                    ...
                    //cm.召唤怪物(bossid, bossxl, bossjy, 1, fubendt, 382, 593);
