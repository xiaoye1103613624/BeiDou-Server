	...
	else 
	{
        ...
        if (status == 0) 
		{
			...
			if(cm.getPlayer().getMapId()==180000001)
			{
				...
				add += "\r\n\r\n"
				add += "\t          #L1#"+红色箭头+蓝色箭头+"  #k挑战 黄  龙（战力）#l \r\n";
				//add += "\t          #L2#"+红色箭头+蓝色箭头+"  #b挑战 双头蛇（破攻）#l\r\n";
				//add += "\t          #L3#"+红色箭头+蓝色箭头+"  #r挑战 赤  虎（称号）#l\r\n\r\n";
...
//------------------------------------------------------------------------
		...
		else if (status == 1) 
		{
			...
			{
					cm.dispose();
					cm.openNpc(9000095, "云林天宫-黄龙");
			}
			if (selection == 2) 
			{
					cm.dispose();
					cm.openNpc(9000434, "云林天宫-双头蛇");
			}
			if (selection == 3) 
			{
					cm.dispose();
					cm.openNpc(9000434, "云林天宫-赤虎");
			}
			if (selection == 4) 
			{
					cm.dispose();
					cm.openNpc(9000434, "云林天宫积分商店");
			}
		}
	}
}
