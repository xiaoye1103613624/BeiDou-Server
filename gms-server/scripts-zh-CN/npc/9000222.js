...
var 列表 = [
	{
		...
		制作列表: [
			...
			{
				代码: 2048401, 金币: 0, 开放天数: 1, //上古法器孵化器
				需求条件: [
					{ 物品代码: 2048402, 数量: 5 },
					{ 物品代码: 3994731, 数量: 10 },
				]
			...
			{
				代码: 2048402, 金币: 0, 开放天数: 1, //史诗神器孵化器
				需求条件: [
					{ 物品代码: 2048403, 数量: 10 },
					{ 物品代码: 3994731, 数量: 10 },
				]
			...
			{
				代码: 2048724, 金币: 0, 开放天数: 1, //神级强化石
				需求条件: [
					{ 物品代码: 2048708, 数量: 1000 },
					{ 物品代码: 3994731, 数量: 5 },
				]
			},
			{
				代码: 4321026, 金币: 8888888, 开放天数: 1, //元灵圣晶
				需求条件: [
					{ 物品代码: 4031952, 数量: 100 },
				]
			},
			{
				代码: 4310038, 金币: 0, 开放天数: 1, //君主币
				需求条件: [
					{ 物品代码: 3994731, 数量: 1 },
					{ 物品代码: 4310143, 数量: 10 },
					{ 物品代码: 4000038, 数量: 888 },
					{ 物品代码: 4000313, 数量: 5888 },
					{ 物品代码: 4001126, 数量: 18888 },
				]
			},
			{
			...
			{
				代码: 3605022, 金币: 10000000, 开放天数: 1, //高级武器强化
				需求条件: [
					{ 物品代码: 4000464, 数量: 999 },
					{ 物品代码: 4000038, 数量: 3999 },
					{ 物品代码: 4001165, 数量: 6999 },
				]
			},
			{
				代码: 3605023, 金币: 30000000, 开放天数: 1, //高级套装强化
				需求条件: [
					{ 物品代码: 4000464, 数量: 599 },
					{ 物品代码: 4000313, 数量: 3999 },
					{ 物品代码: 4001126, 数量: 6999 },
				]
			},
	/*		{
				代码: 3700294, 金币: 30000000, 开放天数: 1, //星辰灵珠
				需求条件: [
					{ 物品代码: 3700291, 数量: 10 },
				]
			},
			{
				代码: 3700293, 金币: 100000000, 开放天数: 1, //宇宙灵珠
				需求条件: [
					{ 物品代码: 3700294, 数量: 10 },
				]
			},
...
*/
			{
				代码: 4001268, 金币: 0, 开放天数: 1, //氪结晶体
				需求条件: [
					{ 物品代码: 4011007, 数量: 1000 },
					{ 物品代码: 4000464, 数量: 388 },
					{ 物品代码: 3994731, 数量: 5 },
				]
			},
			...
			{
				代码: 4001269, 金币: 0, 开放天数: 1, //氪结晶体
				需求条件: [
					{ 物品代码: 4021009, 数量: 1000 },
					{ 物品代码: 4000464, 数量: 388 },
					{ 物品代码: 3994731, 数量: 5 },
				]
			},
    ...
    if (mode == -1) {
        ...
        if (status == 0) {
            ...
            if (检测要求 == true) {
				...
				cm.喇叭(2, "" + cm.getName() + ":在 黑暗领域（八大陆） 制作出了 "+ itemName +"*" + sele2 + "个");
                status = -1;
                return;
            }
        }
