            ...
            if (playerStatus) {
                ...
                if (stage1leader == "done") {
                    if (passes) {
                        ...
                        cm.sendNext("你确定给我带来了10张#i4001022#？请检查一下自己的背包是否足够。");
                    }
                    cm.dispose();
                } else {
                    cm.sendOk("欢迎来到 玩具之城 - (#r组队任务#k)第#b1#k阶段\r\n\r\n看看周围是不是有很多老鼠？请你和你的队员一起消灭这些老鼠带来#r10张通行证#k给我……");
                    eim.setProperty("stage1leader", "done");
                    cm.dispose();
                }
            } else {
                cm.sendNext("欢迎来到 玩具之城 - (#r组队任务#k)第#b1#k阶段\r\n\r\n看看周围是不是有很多老鼠？请打败这些老鼠带来#r10张通行证#k给我,如果你成功拿到了通行证请交给你们的组长。然后再请他转交给我……");
                cm.dispose();
            }
        } else {
