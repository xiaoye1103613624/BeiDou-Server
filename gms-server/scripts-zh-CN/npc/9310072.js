...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
			...
			text += ""
			text += "                  #k"+皇冠白+" #r#e#w兑 换 中 心#n#k "+皇冠白+"\r\n\r\n";
			text += "  "+猫左+中条猫+中条猫+中条猫+中条猫+中条猫+中条猫+中条猫+中条猫+中条猫+中条猫+中条猫+中条猫+中条猫+中条猫+中条猫+中条猫+中条猫+中条猫+中条猫+中条猫+猫右+"\r\n";
            
            text += "\t#L48##b#v1112426#【饰品兑换】   #L49##b#v4001128#【药桶兑换】#l\r\n\r\n"//3
			
			//text += "\t#L49##k#fUI/Basic/BtHide3/mouseOver/0#【点卷兑换】#l\r\n\r\n"//3
			
			text += "\t#L51##b#v4310034#【材料兑换】   #L520##b#v4310058#【吸宠购买】\r\n\r\n"    
			//#L50##b"+金币图标+"【洗血中心】\r\n\r\n"  
			//text += "\t#L50##b#v4001126#【洗血兑换】\r\n\r\n"
			//text += "\t          #L111##b#v4310058#【必成购买】#l   \r\n\r\n"
			//text += "\t          #L52##b#v4310058#【必成购买】#l   \r\n\r\n"
			//text += "\t#L1##d#v4001126#兑换#d#fUI/Basic/BtHide3/mouseOver/0#金币(#r比例 1:5000#d)提示：此为全部兑换#l\r\n"//3
            ...
            cm.sendSimple(text);
		}else if (selection == 52) {//游戏中心
				cm.dispose();
				cm.openNpc(3003302, 52);
        }
		else if (selection == 51) {//游戏中心
				cm.dispose();
				cm.openNpc(3003302, 51);
        }
		else if (selection == 50) {//游戏中心
				cm.dispose();
				cm.openNpc(3003302, 50);
        } 
		else if (selection == 49) {//游戏中心
				cm.dispose();
				cm.openNpc(3003302, 49);
        } 
		else if (selection == 48) {//游戏中心
				cm.dispose();
				cm.openNpc(3003302, 48);
				} 
		else if (selection == 520) {//游戏中心
				cm.dispose();
				cm.openNpc(3003302, 520);
        } 
            ...
            if (beauty == 1) {
                ...
                if (zliang > 0){
					...
					cm.gainMeso(5000*zliang);					
							
                    cm.sendOk("兑换成功。共兑换了:[#r"+(zliang)+"#k] 个。");
					cm.worldMessage(6,"[相框兑换]：玩家 "+cm.getName()+" 努力搬砖,在自由相框兑换了："+(zliang*5000)+" 金币。");
					cm.dispose();
                } else {
