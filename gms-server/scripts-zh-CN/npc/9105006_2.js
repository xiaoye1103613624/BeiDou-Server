...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        cm.sendSimple("嗨，我是嘟嘟皇家理发师 如果你有 #b#t5150040##k , 我就可以帮你修理这个世界最流行的头发！！我可是楼下的那位师傅，所以在我这里修理价格可不菲，不过我这里是指定剪发，请选择你喜欢的发型吧！ \r\n#L0#使用: #i5150040##t5150040#更换潮流发型！\r\n#L1#使用: #i5151001##t5151001#更换染发\r\n");
    } else if (status == 1) {
        if (selection == 0) {
