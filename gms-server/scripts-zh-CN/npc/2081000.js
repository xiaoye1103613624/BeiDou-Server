    ...
    if (status == 0) {
        ...
        if (section == 0) {
            ...
            if (cm.canHold()) {
                if (cm.haveItem(4031348)) {
                    ...
                    cm.sendNext("请到玩具城44层找NPC购买#t4031348#。");
                    cm.safeDispose();
                }
            } else {
        ...
        if (section == 0) {
            ...
            if (cm.haveItem(itemID[temp])) {
                ...
                cm.sendGetNumber("你要捐多少个 #b#t" + itemID[temp] + "#k'我会给你很好的酬勞的！", 1, 1, 999);
            } else {
        ...
        if (section == 0) {
            ...
            if (cm.haveItem(4031348)) { //2nd check need item
                ...
                cm.sendOk("恭喜你已经獲得#t4031860# x1 #t4031861# x1");
            } else {
