...
function action(mode, type, selection) {
    ...
    if (status == 0) {
		cm.sendNext("Oh, look, it's #h0#? How was your trip? Was it worth disobeying orders? And how was your family? Heh heh...", 2159308);
    } else if (status == 1) {
		...
		cm.sendNext("Really? This is treason, you know! Are you really so weak that losing your family makes you do this? Pathetic!", 2159308);
	} else if (status == 3) {
		...
		cm.sendDirectionStatus(1, 1000);
		cm.sendNext("You disappoint me. You don't understand the Black Mage! Eliminate the traitor!", 2159308);
	} else if (status == 4) {
