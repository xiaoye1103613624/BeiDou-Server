...
var 列表 = [
	{
		...
		制作列表: [
			{
				装备代码: 1143165, 点券: 3000000, 开放天数: 1, //永恒
				需求条件: [
					{ 物品代码: 1143185, 数量: 1 },
					{ 物品代码: 3994659, 数量: 60000 },
					{ 物品代码: 4031160, 数量: 500 },
				],
				仙级: 22,  // 永恒
				道具说明: "#r#d",
			...
			{
				装备代码: 1143199, 点券: 6000000, 开放天数: 1, //创世
				需求条件: [
					{ 物品代码: 1143165, 数量: 1 },
					{ 物品代码: 3994659, 数量: 100000 },
					{ 物品代码: 4031160, 数量: 1000 },
				],
				仙级: 23,  // 创世
				道具说明: "#r#d",
			...
			{
				装备代码: 1143183, 点券: 10000000, 开放天数: 1, //超脱
				需求条件: [
					{ 物品代码: 1143199, 数量: 1 },
					{ 物品代码: 3994659, 数量: 200000 },
					{ 物品代码: 4031160, 数量: 2000 },
				],
				仙级: 24,  // 超脱
				道具说明: "#r#d",
			...
			if (类型选择 != null) {
				...
				for (var j = 0; j < 制作选择.length; j++) {
					if (制作选择[j].开放天数 >= 读取开服天数()) {
						text += "#L" + j + "#锻造:#v" + 制作选择[j].装备代码 + ":##z" + 制作选择[j].装备代码 + "#" + 制作选择[j].道具说明 + "#l\r\n\r\n";
					}
				}
			}
			text += "\r\n";
