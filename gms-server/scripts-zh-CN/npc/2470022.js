...
var itemObjS = {
	"1003172": [[2048402, 1],[1352970, 1],[4310038, 60], [4001245, 60],[4000464, 1200], [4021009, 10000],[4011007, 10000],['金币', 2000000000],['进阶', 1005004],['属性', 100,100,100,100,100,100]], //帽子
	"1052314": [[2048402, 1],[1352970, 1],[4310038, 60], [4001245, 60],[4000464, 1200], [4021009, 10000],[4011007, 10000],['金币', 2000000000],['进阶', 1053309],['属性', 100,100,100,100,100,100]], //衣服
	"1072485": [[2048402, 1],[1352970, 1],[4310038, 60], [4001245, 60],[4000464, 1200], [4021009, 10000],[4011007, 10000],['金币', 2000000000],['进阶', 1072637],['属性', 100,100,100,100,100,100]], //靴子
	"1082295": [[2048402, 1],[1352970, 1],[4310038, 60], [4001245, 60],[4000464, 1200], [4021009, 10000],[4011007, 10000],['金币', 2000000000],['进阶', 1082671],['属性', 100,100,100,100,100,100]], //手套
	"1102275": [[2048402, 1],[1352970, 1],[4310038, 60], [4001245, 60],[4000464, 1200], [4021009, 10000],[4011007, 10000],['金币', 2000000000],['进阶', 1102946],['属性', 100,100,100,100,100,100]], //披风
	"1132143": [[2048402, 1],[1352970, 1],[4310038, 60], [4001245, 60],[4000464, 1200], [4021009, 10000],[4011007, 10000],['金币', 2000000000],['进阶', 1132142],['属性', 100,100,100,100,100,100]], //腰带
	
	"1098006": [[2048402, 1],[1352970, 1],[4310038, 180], [4001245, 180],[4000464, 3600], [4021009, 30000],[4011007, 30000],['金币', 2000000000],['进阶', 1098009],['属性', 100,100,100,100,100,100]], //盾牌
	
	"1302355": [[2048402, 1],[1352970, 1],[4310038, 120], [4001245, 120],[4000464, 2400], [4021009, 20000],[4011007, 20000],['金币', 2000000000],['进阶', 1402334],['属性', 100,100,100,100,100,100]], //单手剑
	"1402268": [[2048402, 1],[1352970, 1],[4310038, 120], [4001245, 120],[4000464, 2400], [4021009, 20000],[4011007, 20000],['金币', 2000000000],['进阶', 1402334],['属性', 100,100,100,100,100,100]], //双手剑
	"1432227": [[2048402, 1],[1352970, 1],[4310038, 120], [4001245, 120],[4000464, 2400], [4021009, 20000],[4011007, 20000],['金币', 2000000000],['进阶', 1432308],['属性', 100,100,100,100,100,100]], //枪
	"1442285": [[2048402, 1],[1352970, 1],[4310038, 120], [4001245, 120],[4000464, 2400], [4021009, 20000],[4011007, 20000],['金币', 2000000000],['进阶', 1442116],['属性', 100,100,100,100,100,100]], //矛
	"1382273": [[2048402, 1],[1352970, 1],[4310038, 120], [4001245, 120],[4000464, 2400], [4021009, 20000],[4011007, 20000],['金币', 2000000000],['进阶', 1382269],['属性', 100,100,100,100,100,100]], //长杖
	"1452266": [[2048402, 1],[1352970, 1],[4310038, 120], [4001245, 120],[4000464, 2400], [4021009, 20000],[4011007, 20000],['金币', 2000000000],['进阶', 1452309],['属性', 100,100,100,100,100,100]], //弓
	"1462252": [[2048402, 1],[1352970, 1],[4310038, 120], [4001245, 120],[4000464, 2400], [4021009, 20000],[4011007, 20000],['金币', 2000000000],['进阶', 1462247],['属性', 100,100,100,100,100,100]], //弩
	"1472275": [[2048402, 1],[1352970, 1],[4310038, 120], [4001245, 120],[4000464, 2400], [4021009, 20000],[4011007, 20000],['金币', 2000000000],['进阶', 1472269],['属性', 100,100,100,100,100,100]], //拳套
	"1332289": [[2048402, 1],[1352970, 1],[4310038, 120], [4001245, 120],[4000464, 2400], [4021009, 20000],[4011007, 20000],['金币', 2000000000],['进阶', 1332283],['属性', 100,100,100,100,100,100]], //短刀
	"1482232": [[2048402, 1],[1352970, 1],[4310038, 120], [4001245, 120],[4000464, 2400], [4021009, 20000],[4011007, 20000],['金币', 2000000000],['进阶', 1482206],['属性', 100,100,100,100,100,100]], //指节
	"1492245": [[2048402, 1],[1352970, 1],[4310038, 120], [4001245, 120],[4000464, 2400], [4021009, 20000],[4011007, 20000],['金币', 2000000000],['进阶', 1492239],['属性', 100,100,100,100,100,100]], //短枪
    ...
    if (status == 0) {
		...
		var 是否101 = "#r未满足 "+开+"#k"; 
			if('金币' == needItems[i][0]) {
				...
				text += "\r\n                     #b【特别说明】\r\n";
				text += "          #r首饰6件 #d触发套装属性#r10%#d额外附加伤害 #n#k\r\n";
				text += "          #r武器1件 #d触发套装属性#r10%#d额外附加伤害 #n#k\r\n";
				text += "          #r盾牌1件 #d触发套装属性#r10%#d额外附加伤害 #n#k\r\n";
			text += "#r" +美化4+""+美化6+""+美化6+""+美化6+""+美化6+""+美化6+""+美化6+""+美化6+""+美化6+""+美化6+""+美化6+""+美化6+""+美化6+""+美化6+""+美化6+""+美化5+"#k#k\r\n";
		...
		// text += "\r\n     "+向下+" "+向下+" "+向下+" "+向下+"  "+向下+" "+向下+" "+向下+" "+向下+" "+向下+" "+向下+"#n#k\r\n";
		        ...
		        text += "       [ "+向下+" #d[可强化次数]恢复为#r全新10次#d"+向下+" ] #n#k\r\n";
		...
		for(var i = 0; i < needItems.length; i++) {
			...
			//	item2.setUpgradeSlots(item2.getUpgradeSlots());   //新装备多少次，砸卷就多少次
				item2.setUpgradeSlots(10); //制作出来的装备 砸卷次数10次
