...
function action(mode, type, selection) {
   ...
   status--;
	...
	text += "#r翅膀一级进价需要以下物品:#n\r\n        #v1102005##d#z1102005# X 1 #v4000463# X 100\r\n   #v4001006# X 30     #v4000313# X 300 #v4001126# X 300 金币：1000万 \r\n        "+奖励+"\r\n#v1102184##z1102184# 全属性+5 X 1"
	...
	//text += "     \r\n"
		...
		else if(cm.haveItem(1102005,1) && cm.haveItem(4000463,100) && cm.haveItem(4000313,300) && cm.haveItem(4001126,300) && cm.haveItem(4001006,30)){
...
cm.全服黄色喇叭("[翅膀进价] : 恭喜玩家 【"+cm.getPlayer().getName()+"】 成功进价一级翅膀全属性+5，未来的明日之星！")
            ...
            cm.sendOk("进价翅膀材料或者不足#v1102005#X1#v4000463#X100#v4000313#X300#v4001006# X 30#v4001126#X300\r\n");
            cm.dispose();
			}
		}
    }
