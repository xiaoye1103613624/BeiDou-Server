...
function action(mode, type, selection) {
    ...
    if (status == 0) {
		...
		cm.sendOk("恭喜你，成功升级!");
		Packages.handling.world.World.Broadcast.broadcastMessage(Packages.tools.MaplePacketCreator.serverNotice(9,cm.getClient().getChannel(),"装备继承锻造" + " : " + cm.getPlayer().getName() +" 成功继承锻造出神秘鞋子",true));
