    ...
    if (mode == -1) {
        ...
        if (status == 0) {
           ...
           // text += "#L3##r" + 蓝色箭头 + "挑战地狱船长#g>>>>>>需要#b1个#v4000460#1个#v4000461#1个#v4000462#\r\n\r\n"//3
			...
			//text +="#L12##d#v1902430#进阶坐骑合成#v1902430##l #L23##d#v1903021#终极坐骑合成#v1903021##l\r\n\r\n";
			//text +="              #L22##r#v1702912#进阶武器合成#v1702912##l\r\n\r\n";
		...
		if (cm.haveItem(1122264,3)&&cm.haveItem(1122265,2)&&cm.haveItem(1122266,1)&&cm.getMeso() > 30000000) {
			...
			cm.openNpc(9120054,1314);
		  }else if (selection == 23){
			cm.openNpc(9120054,1315);	
		}else if (selection == 22){
			cm.openNpc(9120054,666);
		}
    }
}
