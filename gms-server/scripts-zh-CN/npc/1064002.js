...
var 扩充 = { 类型: "点券", 价格: 2000, 扩充Log: "世界之树", 上限: 1 }; //世界树扩充 改了影响到BOSS门口NPC，要同步
...
var 商城 = [
    ...
    { 代码: 3700290, 价格: 10000, 数量: 100, 类型: "积分" },
	
	{ 代码: 3605009, 价格: 1000, 数量: 1, 类型: "积分" },
    { 代码: 3605009, 价格: 10000, 数量: 10, 类型: "积分" },
    { 代码: 3605009, 价格: 100000, 数量: 100, 类型: "积分" },
...
function action(mode, type, selection) {
	if (mode == -1) {
		...
		if (status == 0) {
			...
			text += "\t#d" + 广播 + " #k" + 功能名称 + "所有BOSS共享一个扩充次数\r\n";
