...
function start() {
    cm.sendSimple("怎样了？ \r #b#L0# 请帮我解除石锁#l \r #L1# 帮助我锻练道具#l");
}
...
function action(mode, type, selection) {
    ...
    case 0:
        if (selection == 0) {
            cm.sendNext("我是诺兰，司令部技术负责人。现在司令部始终都在谈论着你的事。要是能协助我破坏机械军团，我也会帮助你。使用机械军团布雷兹的技术，应该可以制造出强力的道具吧。")
        } else {
            status = 9;
            cm.sendSimple("决定那一个？\r\n#b#L0##t2070019##l\r\n#L1##t2330007##l");
        }
    ...
    case 10:
        if (selection == 0) {
            ...
            if (cm.haveItem(4032168, 1) && cm.haveItem(4032181, 2500) && cm.haveItem(4032170, 1) && cm.haveItem(2330003, 1) && (cm.getMeso() >= 150000000)) {
                ...
                cm.sendNext("咦？你好像没有必要的素材嘛？\r\n制造#t2330007#需要有#t4032168#、#t4032171#、#t02330003#1个、#t4032181#2,500片以及500,000,000金币。");
            }
        }
        cm.dispose();
        break;
