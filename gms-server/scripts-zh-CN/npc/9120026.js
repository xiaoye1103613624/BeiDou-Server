...
var 红色左上 = "#fUI/ChatBalloon/mob/1/nw#";
var 红色右上 = "#fUI/ChatBalloon/mob/1/ne#";
var 红色上中 = "#fUI/ChatBalloon/mob/1/n#";
var 红色下中 = "#fUI/ChatBalloon/mob/1/s#";
var 红色左下 = "#fUI/ChatBalloon/mob/1/sw#";
var 红色右下 = "#fUI/ChatBalloon/mob/1/se#";
	...
	else 
	{
        ...
        if (status == 0) 
		{
			...
			if(cm.getPlayer().getMapId()==180000001)
			{
				...
				add += "             #r[ #d称号BOSS掉落  #b#z3604010# #r]\r\n";
				add += "             #r[ #d破攻BOSS掉落  #b#z3604010# #r]\r\n";
				add += "             #r[ #d战力BOSS掉落  #b#z3604010# #r]\r\n";
				add += "\r\n\r\n"
				add += "\t      #L1#"+红色箭头+蓝色箭头+"  #e#k挑战 貔貅（战力）#n#l\r\n";
				add += "\t      #L2#"+红色箭头+蓝色箭头+"  #e#b挑战 格雷德（破攻）#n#l\r\n";
				add += "\t      #L3#"+红色箭头+蓝色箭头+"  #e#r挑战 阿尔卡努斯（称号）#n#l\r\n\r\n";
...
//------------------------------------------------------------------------
		...
		else if (status == 1) 
		{
			...
			{
					cm.dispose();
					cm.openNpc(9120026, "九大陆-貔貅");
			}
			if (selection == 2) 
			{
					cm.dispose();
					cm.openNpc(9120026, "九大陆-格雷德");
			}
			if (selection == 3) 
			{
					cm.dispose();
					cm.openNpc(9120026, "九大陆-阿尔卡努斯");//这个代码三小的挑战NPC外观，9000434
			}
			if (selection == 4) 
			{
					cm.dispose();
					cm.openNpc(9120026, "九大陆积分商店");
			}
		}
	}
}
