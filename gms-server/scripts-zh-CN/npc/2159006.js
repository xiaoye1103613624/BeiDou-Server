...
function action(mode, type, selection) {
    ...
    if (cm.getInfoQuest(23007).indexOf("vel00=1") == -1 && cm.getInfoQuest(23007).indexOf("vel01=1") == -1) {
	    ...
	    cm.sendNextPrev("Whos talking?! Where are you?!", 2);
        } else if (status == 2) {
	    ...
	    cm.sendNextPrev("Wait, what are you talking about? Someone''s doing experiments on you?! And who''s Gelimer?", 2);
        } else if (status == 2) {
	    ...
	    cm.sendNextPrev("#b(Vita closes her eyes like she''s given up. What should you do? How about trying to break open the vat?)#k", 2);
        } else if (status == 2) {
