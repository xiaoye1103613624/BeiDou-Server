...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
			...
			text += "#L4##r我要用10万点杀怪数量兑换#k100个#v4000313##l\r\n\r\n\r\n"//3
            text += "#L3##r我要用100万杀怪次数兑换#k杀怪王勋章 \r\n            #b(4属性+20 HP1000 MP1000)#l\r\n\r\n"//3
            cm.sendSimple(text);
        } else if (selection == 1) {
            ...
            if (cm.getPlayer().getSG() >= 1000000) {
                ...
                //cm.gainMeso(100000);
                cm.sendOk("兑换成功！");
                cm.worldMessage(6, "玩家：[" + cm.getName() + "]用100万[杀怪数量]兑换了杀怪王勋章 4属性+20 HP1000 MP1000，再接再厉哦！");
                cm.dispose();
            } else {
