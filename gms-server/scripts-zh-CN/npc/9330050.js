...
//这个脚本缺少需要的物品 暂未添加物品
    if (status == 0) {
	//cm.sendSimple("嗨，我是#p9330050# 如果你有 #b#t5151023##k 或者 #b#t5151023##k, 我就可以免费帮你弄好看的头发。 \r\n#L0#使用: #i5150028##t5150028##l\r\n#L1#使用: #i5151023##t5151023##l");
    } else if (status == 1) {
	if (selection == 0) {
	    ...
	    cm.sendYesNo("确定要使用 #b#t5150028##k 随机剪发了？？");
	    ...
	    cm.sendYesNo("确定要使用 #b#t5151023##k 随机染发了？？");
	}
    } else if (status == 2){
	if (beauty == 1){
		...
		cm.sendOk("痾.... 貌似没有#b#t5150028##k。");
	    }
	} else {
	    if (cm.setRandomAvatar(5151023, hair_Colo_new) == 1) {
		cm.sendOk("享受！");
	    } else {
		cm.sendOk("痾.... 貌似没有#b#t5151023##k。");
	    }
	}
	cm.safeDispose();
    }
