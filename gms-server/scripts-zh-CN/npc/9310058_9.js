...
function action(mode, type, selection) {
	...
	if (status == 0) {
		var text = "#b还在愁魔方不够用吗？只要肯努力，魔方就是无限的#k\r\n#n肚子好饿啊，你能做些东西给我吃吗？我会给你应有的报酬的。\r\n制作材料世界怪物均有掉了\r\n";
		text+="#b#L0##v4032592# 制作饺子可以获得 #r#z2432353##k#l\r\n";
		text+="#b#L1##v4032593# 制作春卷可以获得 #r#z5062002##k#l\r\n";
		text+="#b#L2##v4032594# 制作年糕可以获得 #r#z5062500##k#l\r\n";
		cm.sendSimple(text);
	} else if (status == 1){
		typed = selection;
		...
		for(var key in needItem) {
			...
			text+=isEnough+" #k需要20个#b#v"+needItem[key]+"##t"+needItem[key]+"#\r\n";
		}
		if (isSuccess == 3) {
