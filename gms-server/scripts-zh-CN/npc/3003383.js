...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
            ...
            if (selection == 0) {//副本传送
			cm.dispose();
             cm.openNpc(3003383,100);
            } 
			else if (selection == 1) {//副本兑换奖励
			cm.dispose();
              cm.openNpc(3003383,200);
            }
			else if(selection == 2){
				cm.dispose();
                cm.openNpc(3003383,300);
			}
				else if(selection == 3){
					cm.dispose();
                cm.openNpc(3003383,400);
			}
			
				else if(selection == 4){
					cm.dispose();
                cm.openNpc(3003383,500);
				}
				
				else if(selection == 5){
					cm.dispose();
                cm.openNpc(3003383,600);
				}
				
				else if(selection == 6){
					cm.dispose();
                cm.openNpc(3003383,700);
				}
				
				else if(selection == 7){
					cm.dispose();
                cm.openNpc(3003383,800);
				}
				
				else if(selection == 8){
					cm.dispose();
                cm.openNpc(3003383,900);
        }
        }
    }
}
