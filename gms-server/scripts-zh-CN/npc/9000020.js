...
var maps = Array(
Array(500000000,3000,300),// 泰国
Array(702000000,3000,300),
Array(600000000,3000,300),
Array(540000000,3000,300),
Array(800000000,3000,300),// 古代神社
Array(701000000,3000,300) //上海
...
function action(mode, type, selection) {
	...
	if (cm.getChar().getMapId() != 500000000 && cm.getChar().getMapId() != 702000000 && cm.getChar().getMapId() != 800000000 && cm.getChar().getMapId() != 600000000 && cm.getChar().getMapId() != 540000000 && cm.getChar().getMapId() != 550000000 && cm.getChar().getMapId() != 541000000) {
		if (status == 0) {
			...
			cm.sendSimple("现在就可以去往 #b泰国的水上市场,日本古代神社#k游览一番。在各旅游地我都会为大家提供满意热诚的服务。那么请准备好，新手可以9折优惠。\r\n#b#L0#查看旅游线路.#k#l");
		} else if (status == 2) {
var selStr = "现在就可以去往 #b泰国的水上市场,日本古代神社#k游览一番。在各旅游地我都会为大家提供满意热诚的服务。那么请准备好，新手可以9折优惠。#b";
				if (cm.getJob() == 0) {
