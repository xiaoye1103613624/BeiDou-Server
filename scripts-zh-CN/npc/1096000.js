...
function action(mode, type, selection) {
	...
	if (status == 0) {
		cm.sendNext("So, why do you want to go to Maple Island, anyway? Not many people head that way these days. Judging by your clothes, you're not a tourist either.");
	} else if (status == 1) {
		...
		cm.sendNext("It sure does! Maple Island is a great place to train, since there are no dangerous monsters there. Plus, you'll make plenty of friends and learn the basics. When you're ready, there's a big, wide world out there for you to explore!");
	} else if (status == 3) {
		...
		cm.sendNext("What a great attitude! That will help you succeed. You can't ever be sure of what will happen, though. Just remember, #beverything happens for a reason.#k");
	} else if (status == 5) {
