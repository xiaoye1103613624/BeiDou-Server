...
function action(mode, type, selection) {
    ...
    if (chat == 0)
        ...
        cm.sendNextPrev("What is your name?", 1);
    else if (chat == 2)
        cm.sendNextPrev("I don't have one. Just call me #bKiddo#k. That's what the old man calls me.", 3);
    else if (chat == 3)
        cm.sendNextPrev("Is he your grandpa? Where are your parents?", 1);
    else if (chat == 4)
        ...
        cm.sendNextPrev("Do you know the name Chromile? The Knight of Light?", 1);
    else if (chat == 6)
