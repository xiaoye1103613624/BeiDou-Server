...
function action(mode, type, selection) {
    ...
    switch (status) {
        ...
        case 2:
            if (selected == 0) {
                cm.sendNextPrev("But you can't just use any items for Jewel Crafting! Only  #i1112762:# #t1112762# and #i1132191:# #t1132191#! ", 4, 9000132);
            } else if (selected == 1) {
                cm.sendNextPrev("Also, you can obtain Rank S and A jewels with a #t2048402#!", 4, 9000132);
                cm.dispose();
            } else if (selected == 2) {
                cm.sendNextPrev("There are #bMighty Jewels#k, #bLucky Jewels#k, #bNimble Jewels#k, and #bKeen Jewels#k. They'll make you stronger, luckier, more dextrous, and smarter! The higher the rank, the more stats it carries. Why don't you bring me jewels suited for your needs?", 4, 9000132);
                cm.dispose();
            } else if (selected == 3) {
        ...
        case 3:
            if (selected == 0) {
                cm.sendNextPrev("I'm embarrassed to admit this, but Idon't always know my own strength. Sometimes I... break things. But hey! If you have jewel powder, I can form it into new jewels.", 4, 9000132);
            }
            break;
        case 4:
            if (selected == 0) {
                cm.sendNextPrev("Click on the #b#eJeweler's Mortar#n#k next to me to access Jewel Crafting, and see for yourself!", 4, 9000132);
                cm.dispose();
            }
            break;
    }
