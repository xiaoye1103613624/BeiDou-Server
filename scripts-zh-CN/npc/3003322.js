...
function action(mode, type, selection) {
    ...
    if (cm.getMapId() == 180000001) {
        ...
        var 
		selStr = "     "+大黄星+""+小烟花 +"欢迎来到【 #r" + cm.getServerName() + "#k 】抽奖中心"+小烟花 +""+大黄星+"\r\n\r\n\r\n";
