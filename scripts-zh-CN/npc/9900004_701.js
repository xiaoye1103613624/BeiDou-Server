...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
			...
			text += "#r"+选择获得+"首充礼包#k#n#l\r\n"
            text += "#L1##b#v1142081#首充福利\r\n"
			//text += "#L2##b#v1142617#每日福利VIP②\r\n"
			//text += "#L3##b#v1142623#每日福利VIP③#l\r\n\r\n"
            text += "#r"+选择获得+"领取会员①②③#k#n#l\r\n"
            text += "#L6##b#v1142081#首充会员\r\n"
			//text += "#L4##b#v1142617#领取会员VIP②\r\n"
            //text += "#L5##b#v1142623#领取会员VIP③\r\n"
			//text += "#L7##b#v4000422#领取礼包奖励\r\n"
			//text += "#L8##b#v4031506#领取礼包奖励\r\n"
			//text += "#L9##b#v4031505#领取礼包奖励\r\n"
			//text += "#L10##b#v4031504#领取礼包奖励\r\n"
            cm.sendSimple(text);
        } else if (selection == 1) {
			cm.dispose();
