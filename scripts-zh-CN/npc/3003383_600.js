   ...
   status--;
	...
	//text += "     \r\n"
        cm.sendSimple(text);
            ...
            cm.dispose();
        }else if(cm.haveItem(1102096,1) && cm.haveItem(4000463,1600) && cm.haveItem(4001006,500)&& cm.haveItem(4000244,500)&& cm.haveItem(4000245,500)&& cm.haveItem(4000313,2800) && cm.haveItem(4001126,2800) && cm.haveItem(4000038,300)){
...
cm.全服黄色喇叭("[翅膀进价] : 恭喜玩家 【"+cm.getPlayer().getName()+"】 成功进价六级翅膀全属性+15，功魔+18,未来的明日之星！")
            ...
            cm.sendOk("进价翅膀材料或者不足#v1102096#X1#v4000463#X1600#v4000313#X2800#v4001126#X2800#v4000038#X300#v4001006# X 500#v4000244# X 500#v4000245# X 500\r\n");
            cm.dispose();
			}
		}
    }
