	...
	else 
	{
        ...
        if (status == 0) 
		{
			...
			if(cm.getPlayer().getMapId()==180000001)
			{
				...
				add += "                          #v1092042#\r\n";
				add += "                      -  "+小new+"  -\r\n";
				add += "       #L1##d"+黄1+"  #d月秒副本 #b[单人/多人]#l\r\n";	
				add += "       #L2##d"+黄2+" #d废弃副本 #b[多人]#l\r\n";
				add += "       #L3##d"+黄3+" #d英语村副本 #b[单人/多人]#l\r\n";
				add += "       #L4##d"+黄4+" #d玩具城副本 #b[多人]#l\r\n";
				add += "       #L5##d"+黄5+" #d魔女塔副本 #b[单人]#l\r\n";
				add += "       #L6##d"+黄6+" #d天空之城副本 #b[多人]#l\r\n";
				add += "       #L7##d"+黄7+" #d毒物森林副本 #b[多人]#l\r\n";
				add += "       #L8##d"+黄8+" #d怪物公园副本 #b[单人/多人]#l\r\n";
				add += "       #L9##d"+黄9+" #d怪物嘉年华副本 #b[多人]#l\r\n";
				add += "                                        #L10##b下一页#l\r\n";
				add +="\r\n"
