...
const EventName = 'LNHXMLDNL';
const EventLevel = 1;
const LevelMin = 30, LevelMax = 255;
var entryMap = 141010400;
var exitMap = 141060000;
...
function start() {
    ...
    // ── 任务门控：32169 已完成 + 32170 已开始但未完成 ──
    if (!cm.isQuestCompleted(32169) || !cm.isQuestStarted(32170) || cm.isQuestCompleted(32170)) {
