...
var count;
var menu = "";
var itemID = new Array(4000637, 4000638,4000639,4000634,4000640,4000641);
var status = -1;
...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        cm.sendSimple("你好，我是这儿的村长马里奥内，你找我有事吗？\r\n#l\r\n#L1##b为了克里塞村的行动#k#l");
    } else if (status == 1) {
        section = selection;
        if (section == 0) {
            cm.sendSimple("需要我帮助你？？\r\n#L0##b我想跟你买一些 #t4031346#.#k#l");
        } else if (section == 1) {
            cm.sendNext("更好的建设村落是村长的职责。所以需要更多更好的道具。你能为了村落捐献出在克里塞村附近收集到的道具吗？");
       } else {
