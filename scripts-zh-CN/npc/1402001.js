...
function action(mode, type, selection) {
    ...
    if (status == 0)
        ...
        cm.sendNextPrev("It's okay old chum, I know you're seeing countless people coming through. It can't be easy to remember all of them, but I was hoping you'd ad least remember ME.", 2);
    else if (status == 3)
        ...
        cm.sendNextPrev("It's really that bad?", 2);
    else if (status == 5)
        ...
        cm.sendNextPrev("That's a good point. That's why I'm here!", 2);
    else if (status == 7)
        cm.sendNextPrev("It's got me pretty worried too. Even the Empress looked worried.\r\nShe was white as a ghost when I saw her...");
    else if (status == 8)
        cm.sendNextPrev("Not looking forward to having a new empress, Kidan?", 2);
    else if (status == 9)
        ...
        cm.sendNextPrev("Do you really think there is another member of the Empress's bloodline?", 2);
    else if (status == 11)
        cm.sendNextPrev("This Hilla woman insisted that she was a descendant to the last Empress.");
    else if (status == 12)
        cm.sendNextPrev("That would explain the foul mood.", 2);
    else if (status == 13)
        ...
        cm.sendNextPrev("It seems awfully convenient, doesn't it?", 2);
    else if (status == 16)
        ...
        cm.sendNextPrev("Don't worry too much, Kidan. I have a feeling these things will all work out.", 2);
    else if (status == 19)
        ...
        cm.sendNextPrev("Confidence is required of both truthsayers and liars. You never know. Maybe someone INCREDIBLE will come swooping in to clear this up.", 2);
    else if (status == 21)
        cm.sendNextPrev("What does that mean? Why are you talking like that?");
    else if (status == 22)
        cm.sendNextPrev("Don't worry yourself! I'm sure I'll see you after everything is said and done.", 2);
    else if (status == 23)
